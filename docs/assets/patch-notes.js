...
class PatchNotesSystem {
    constructor() {
        ...
        this.cacheVersion = '1.0.045254'; // Update this when deploying changes
        this.extensionIcons = {
            core: '🚀',
            ai: '🤖',
            affiliate: '💰',
    ...
    getKnownVersionsForType(type) {
        const knownVersions = {
            'core': ['5.0.0', '5.0.8', '5.0.9', '5.1.1', '5.1.3', '5.1.4', '5.1.5', '5.1.6', '5.1.7', '5.1.8', '5.2.0', '5.2.1', '5.2.2', '5.2.4', '5.2.5', '5.2.6', '5.2.7', '5.2.8', '5.2.9', '5.3.0', '5.3.1', '5.3.2', '5.3.3', '5.3.4', '5.3.7'],
            'staking': ['5.0.3', '5.0.4'],
            'p2p': ['5.0.0', '5.0.4', '5.0.5', '5.0.6', '5.0.7', '5.0.8'],
            'ecommerce': ['5.0.3', '5.0.4', '5.0.5', '5.0.6', '5.0.7', '5.0.8'],
            'ai': [],
            'affiliate': [],
            'ecosystem': ['5.0.5', '5.1.1'],
            'faq': [],
            'forex': ['5.0.3', '5.0.4', '5.0.5', '5.0.6'],
            'futures': ['5.0.4'],
            'ico': [],
            'mailwizard': [],
            'payment': []
