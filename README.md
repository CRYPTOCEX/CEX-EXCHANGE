...
For the main application installation and initial Virtualmin setup, please follow the detailed instructions provided in our official documentation:
  ...
  * **Bicrypto Installation Guide:**  [docs.mashdiv.com/#virtualmin-setup](https://docs.mashdiv.com/#virtualmin-setup) 
  * **Virtualmin Setup Docs:** [docs.mashdiv.com](https://docs.mashdiv.com/)
