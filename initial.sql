...
CREATE TABLE `binary_market` (
  ...
  `minAmount` decimal(16,8) DEFAULT 1 COMMENT 'Minimum order amount for this market',
  `maxAmount` decimal(16,8) DEFAULT 10000 COMMENT 'Maximum order amount for this market',
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `exchange` (`id`, `name`, `title`, `description`, `status`, `licenseStatus`, `version`, `productId`, `type`, `link`) VALUES
(UUID(), 'okx',       'OKX',        'Integrate OKX exchange for spot trading with deep liquidity, real-time market data, order execution, and multi-chain withdrawals.', 0, 1, '5.0.0', 'okx-custom',       'spot', NULL),
(UUID(), 'binanceus', 'Binance.US', 'Connect to Binance.US for compliant spot trading in the United States with real-time market data and order management.',           0, 1, '5.0.0', 'binanceus-custom', 'spot', NULL),
(UUID(), 'bybit',     'Bybit',      'Integrate Bybit exchange for high-performance spot trading with deep liquidity and multi-chain deposit/withdrawal support.',           0, 1, '5.0.0', 'bybit-custom',     'spot', NULL),
(UUID(), 'mexc',      'MEXC',       'Connect to MEXC Global for spot trading across a wide range of digital assets with fast order execution.',                            0, 1, '5.0.0', 'mexc-custom',      'spot', NULL),
(UUID(), 'gate',      'Gate.io',    'Integrate Gate.io exchange for spot trading with broad market coverage, real-time prices, and multi-chain withdrawals.',              0, 1, '5.0.0', 'gate-custom',      'spot', NULL),
(UUID(), 'bitget',    'Bitget',     'Integrate Bitget exchange for spot trading with reliable order execution and multi-network deposit/withdrawal support.',              0, 1, '5.0.0', 'bitget-custom',    'spot', NULL);
...
CREATE TABLE `mlm_referral_reward` (
  ...
  KEY `mlmReferralRewardSourceIdKey` (`sourceId`),
