    ...
    return gatewayPayment.init(
      {
        ...
        lineItems: {
          ...
          get(this: any) {
             ...
             * authentication.
             */
            const value = this.getDataValue("lineItems") as unknown;
            if (value == null) return null;
            if (typeof value === "string") {
              try {
                return JSON.parse(value);
        ...
        billingAddress: {
          ...
          get(this: any) {
             ...
             * authentication.
             */
            const value = this.getDataValue("billingAddress") as unknown;
            if (value == null) return null;
            if (typeof value === "string") {
              try {
                return JSON.parse(value);
        ...
        allocations: {
          ...
          get(this: any) {
             ...
             * authentication.
             */
            const value = this.getDataValue("allocations") as unknown;
            if (value == null) return null;
            if (typeof value === "string") {
              try {
                return JSON.parse(value);
