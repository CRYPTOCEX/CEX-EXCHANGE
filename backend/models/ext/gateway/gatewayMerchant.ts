  ...
  implements gatewayMerchantAttributes
{
  ...
  logo?: string;
  website?: string;
  /** Free-text business category, asked for at registration and shown to the
    ...
    return gatewayMerchant.init(
      {
        ...
        /* The registration form has always collected "Business Type" and the
           settings client round-trips it, but there was no column — so the
           answer was discarded on every registration and the field was a lie
           told to the merchant. */
        businessType: {
        ...
        allowedCurrencies: {
          ...
          get(this: any) {
             ...
             * authentication.
             */
            const value = this.getDataValue("allowedCurrencies") as unknown;
