    ...
    return nftToken.init(
      {
          ...
          set(value: any) {
            ...
            if (typeof value === "string") {
              try {
                ...
                this.setDataValue("attributes", null as any);
              }
              return;
            }
            this.setDataValue("attributes", value ?? (null as any));
          },
        },
        metadataUri: {
          type: DataTypes.STRING(1000),
        ...
        ownerId: {
          ...
          allowNull: true,
          validate: {
            isUUID: { args: ANY_UUID_VERSION, msg: "ownerId: Owner ID must be a valid UUID" },
          },
        },
        creatorId: {
          type: DataTypes.UUID,
          ...
          validate: {
            ...
            isUUID: { args: ANY_UUID_VERSION, msg: "creatorId: Creator ID must be a valid UUID" },
          },
        },
        mintedAt: {
          type: DataTypes.DATE,
