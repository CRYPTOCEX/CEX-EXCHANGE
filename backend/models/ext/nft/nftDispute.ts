    ...
    return nftDispute.init(
      {
        ...
        listingId: {
          ...
          allowNull: true,
          validate: {
            isUUID: { args: ANY_UUID_VERSION, msg: "listingId: Must be a valid UUID" },
          },
        },
        tokenId: {
          type: DataTypes.UUID,
        ...
        respondentId: {
          ...
          allowNull: true,
          validate: {
            isUUID: { args: ANY_UUID_VERSION, msg: "respondentId: Must be a valid UUID" },
          },
        },
        assignedToId: {
          type: DataTypes.UUID,
          allowNull: true,
          validate: {
            isUUID: { args: ANY_UUID_VERSION, msg: "assignedToId: Must be a valid UUID" },
          },
        },
        title: {
          ...
          set(value: any) {
            ...
            if (typeof value === "string") {
              try {
                ...
                this.setDataValue("evidence", null as any);
              }
              return;
            }
            this.setDataValue("evidence", value ?? (null as any));
          },
        },
        resolution: {
          type: DataTypes.TEXT,
        ...
        resolvedById: {
          ...
          allowNull: true,
          validate: {
            isUUID: { args: ANY_UUID_VERSION, msg: "resolvedById: Must be a valid UUID" },
          },
        },
        metadata: {
          type: DataTypes.JSON,
