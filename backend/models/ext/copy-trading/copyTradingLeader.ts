...
// Which instrument classes this leader offers for copying.
export type LeaderTradingType = "SPOT" | "BINARY" | "BOTH";
    ...
    return copyTradingLeader.init(
      {
        ...
        // SPOT = ecosystem spot copying only, BINARY = binary options copying
        // only, BOTH = leader offers both. Defaults to SPOT so pre-existing
        // leaders keep their behavior after auto-sync.
        tradingType: {
          type: DataTypes.ENUM("SPOT", "BINARY", "BOTH"),
          allowNull: false,
          defaultValue: "SPOT",
        },
      ...
      },
      {
        ...
        indexes: [
          ...
          {
            name: "copy_trading_leaders_trading_type_idx",
            fields: [{ name: "tradingType" }],
          },
