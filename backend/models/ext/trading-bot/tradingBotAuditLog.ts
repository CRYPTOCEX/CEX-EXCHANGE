    ...
    return tradingBotAuditLog.init(
      {
        ...
        entityId: {
          ...
          validate: {
            ...
            isUUID: { args: ANY_UUID_VERSION, msg: "entityId: Must be a valid UUID" },
          },
        },
        botId: {
          type: DataTypes.UUID,
        ...
        oldValue: {
          type: DataTypes.JSON,
          allowNull: true,
          get(this: tradingBotAuditLog) {
            const value = this.getDataValue("oldValue") as unknown;
        ...
        newValue: {
          ...
          allowNull: true,
          get(this: tradingBotAuditLog) {
            const value = this.getDataValue("newValue") as unknown;
            if (value == null) return null;
            if (typeof value === "string") {
              try {
                return JSON.parse(value);
