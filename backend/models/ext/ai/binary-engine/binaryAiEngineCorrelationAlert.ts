    ...
    return binaryAiEngineCorrelationAlert.init(
      {
        ...
        deviationPercent: {
          // Stored on a percent scale (e.g. 12.5 = 12.5%). DECIMAL(8,4) matches
          // the correlation-history column and prevents a strict-MySQL overflow
          // (1264) on any deviation >= 10% that DECIMAL(7,6) could not hold.
