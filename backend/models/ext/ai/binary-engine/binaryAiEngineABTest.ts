    ...
    return binaryAiEngineABTest.init(
      {
        ...
        controlConfig: {
           ...
           */
          get(this: binaryAiEngineABTest) {
            const value = this.getDataValue("controlConfig") as unknown;
        ...
        variantConfig: {
           ...
           */
          get(this: binaryAiEngineABTest) {
            const value = this.getDataValue("variantConfig") as unknown;
            if (value == null) return {};
            if (typeof value === "string") {
              try {
                return JSON.parse(value);
        ...
        results: {
           ...
           */
          get(this: binaryAiEngineABTest) {
            const value = this.getDataValue("results") as unknown;
        ...
        variants: {
           ...
           */
          get(this: binaryAiEngineABTest) {
            const value = this.getDataValue("variants") as unknown;
            if (value == null) return null;
            if (typeof value === "string") {
              try {
                return JSON.parse(value);
