...
exports.broadcastCriticalLog = broadcastCriticalLog;
const Websocket_1 = require("@b/handler/Websocket");
const relay_1 = require("@b/handler/ws/relay");
const console_1 = require("@b/utils/console");
const CRON_ROUTE = "/api/admin/system/cron";
function cronDashboardIsWatched() {
    return (0, Websocket_1.hasClients)(CRON_ROUTE) || (0, relay_1.hasRelayAudience)(CRON_ROUTE);
}
...
async function broadcastStatus(cronName, status, extra = {}) {
    ...
    Websocket_1.messageBroker.broadcastToRoute(CRON_ROUTE, {
        type: "status",
        cronName,
        data: { status, ...extra },
        timestamp: new Date(),
...
function broadcastCriticalLog(cronName, logMessage, logType = "error") {
    Websocket_1.messageBroker.broadcastToRoute(CRON_ROUTE, {
        type: "log",
        cronName,
        data: { message: logMessage, logType },
