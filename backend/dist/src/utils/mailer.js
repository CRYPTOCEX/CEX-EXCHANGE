...
async function sendEmailWithProvider(provider, options) {
    if ((0, system_accounts_1.isUnmailableRecipient)(options === null || options === void 0 ? void 0 : options.to)) {
        console_1.logger.debug("EMAIL", `Dropping mail to ${options === null || options === void 0 ? void 0 : options.to}: platform system account or reserved undeliverable domain`);
        return;
    }
    try {
        switch (provider) {
