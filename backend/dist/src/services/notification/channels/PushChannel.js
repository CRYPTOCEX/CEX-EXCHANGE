...
const mobileDevice_1 = require("../utils/mobileDevice");
...
class PushChannel extends BaseChannel_1.BaseChannel {
    ...
    initializeProviders() {
        ...
        if (hasFCMConfig) {
            try {
                ...
                if (this.fcmProvider.validateConfig() && this.fcmProvider.isReady()) {
                    this.hasFCM = true;
                }
                else {
                    this.fcmProvider = null;
    ...
    async send(operation, transaction) {
        ...
        try {
            ...
            const registryTokens = await (0, mobileDevice_1.getActiveMobileTokens)(operation.userId);
    ...
    isWebPushSubscription(token) {
        try {
            ...
            return (parsed &&
                ...
                (0, WebPushProvider_1.isAllowedPushEndpoint)(parsed.endpoint) &&
                parsed.keys &&
    ...
    preparePushData(operation) {
        ...
        const deepLink = (0, deepLinks_1.resolveDeepLink)({
            type: operation.type,
            title: data.title,
        ...
        return {
            ...
            data: {
                ...
                link: data.link || "",
                ...(deepLink
                    ? { appModule: deepLink.module, appPath: deepLink.path }
                    : {}),
                ...data.pushData,
            },
