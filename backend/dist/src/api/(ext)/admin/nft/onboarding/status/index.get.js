...
exports.metadata = {
    ...
    requiresAuth: true,
    permission: "access.nft.settings",
};
exports.default = async (data) => {
    ...
    const roleId = Number((_b = user.roleId) !== null && _b !== void 0 ? _b : user.role);
    if (roleId !== 1) {
    ...
    try {
        ...
        const categoriesCount = ((_c = await ((_a = db_1.models.nftCategory) === null || _a === void 0 ? void 0 : _a.count())) !== null && _c !== void 0 ? _c : 0);
