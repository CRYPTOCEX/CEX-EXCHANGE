...
exports.metadata = {
    ...
    description: "Deletes an NFT category by ID. Prevents deletion if the category has existing collections to maintain data integrity.",
    operationId: "deleteAdminNftCategoryById",
    ...
    requiresAuth: true,
    permission: "delete.nft.category",
};
