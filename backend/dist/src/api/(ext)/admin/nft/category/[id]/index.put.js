...
exports.metadata = {
    ...
    description: "Updates an NFT category's name, description, image, or status by ID. Automatically regenerates the slug if the name is changed.",
    operationId: "updateAdminNftCategoryById",
