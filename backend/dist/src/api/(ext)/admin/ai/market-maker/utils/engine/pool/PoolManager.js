...
class PoolManager {
    ...
    updateCurrentPrice(marketMakerId, price) {
        this.pnlCalculator.updateCurrentPrice(marketMakerId, price);
        this.getBalanceTracker(marketMakerId).setCurrentPrice(price);
    }
    forget(marketMakerId) {
        this.balanceTrackers.delete(marketMakerId);
    }
