...
exports.metadata = {
    ...
    permission: "view.ai.market_maker.pool",
};
exports.default = async (data) => {
    ...
    try {
        baseWallet = await (0, poolWallet_1.getPoolAdminWallet)(user.id, baseCurrency);
    }
    catch (_a) {
    }
    try {
        quoteWallet = await (0, poolWallet_1.getPoolAdminWallet)(user.id, quoteCurrency);
    }
    catch (_b) {
    }
