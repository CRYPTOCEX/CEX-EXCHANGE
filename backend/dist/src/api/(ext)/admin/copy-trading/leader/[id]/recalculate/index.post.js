...
exports.default = async (data) => {
    ...
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Reading current (cached) statistics");
    const cachedStats = await (0, stats_calculator_1.calculateLeaderStats)(id);
    const oldStats = {
        totalTrades: (_a = cachedStats.totalTrades) !== null && _a !== void 0 ? _a : 0,
        winRate: Math.round(((_b = cachedStats.winRate) !== null && _b !== void 0 ? _b : 0) * 100) / 100,
        totalProfit: Math.round(((_c = cachedStats.totalProfit) !== null && _c !== void 0 ? _c : 0) * 100) / 100,
        totalVolume: Math.round(((_d = cachedStats.totalVolume) !== null && _d !== void 0 ? _d : 0) * 100) / 100,
        totalFollowers: (_e = cachedStats.totalFollowers) !== null && _e !== void 0 ? _e : 0,
        roi: Math.round(((_f = cachedStats.roi) !== null && _f !== void 0 ? _f : 0) * 100) / 100,
    };
    ...
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Invalidating cached statistics");
    await (0, stats_calculator_1.invalidateLeaderStatsCache)(id);
