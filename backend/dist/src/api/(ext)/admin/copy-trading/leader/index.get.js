...
exports.metadata = {
    ...
    parameters: [
        ...
        },
        {
            ...
            in: "query",
            schema: { type: "number" },
            description: "Page size sent by the data table (alias of limit)",
        },
        {
            name: "filter",
            in: "query",
            schema: { type: "string" },
            description: "JSON filter object sent by the data table (e.g. userId)",
        },
    ],
    responses: {
...
exports.default = async (data) => {
    ...
    const leaderDirectFilters = (0, query_1.parseFilterParam)(query.filter, []);
    const filterUserId = (0, query_1.takeDirectFilter)(leaderDirectFilters, "userId");
    if (filterUserId)
    ...
    const limit = Math.min(parseInt(query.perPage) || parseInt(query.limit) || 20, 100);
