...
exports.default = async (data) => {
    ...
    await (0, core_1.updateLeaderStats)(id);
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Sending suspension notification to leader");
    await (0, notifications_1.notifyLeaderApplicationEvent)(leader.userId, id, "SUSPENDED", { reason }, ctx);
    ...
    for (const follower of affectedFollowers) {
        await (0, notifications_1.notifyFollowerSubscriptionEvent)(follower.id, "PAUSED", { reason: `Leader suspended: ${reason}` }, ctx);
    }
    await (0, notifications_1.notifyCopyTradingAdmins)("LEADER_SUSPENDED", {
        leaderId: id,
