...
exports.metadata = {
    ...
    description: "Returns a paginated list of all copy trading transactions with filtering options. Supports filtering by transaction type (ALLOCATION, DEALLOCATION, PROFIT_SHARE, TRADE_PROFIT, TRADE_LOSS, FEE, REFUND), status, user ID, leader ID, follower ID, minimum amount, and date range. Includes summary statistics grouped by transaction type.",
    ...
    parameters: [
        ...
        },
        {
            ...
            required: false,
            schema: { type: "string" },
            description: "JSON filter object as sent by the data table (e.g. {\"userId\":\"…\"}). Also honours the transaction's own columns: type, status, currency, description, leaderId, followerId, tradeId, amount, fee, createdAt.",
        },
        {
            name: "sortField",
            in: "query",
...
exports.default = async (data) => {
    ...
    const txDirectFilters = (0, query_1.parseFilterParam)(query.filter, []);
    const filterUserId = (0, query_1.takeDirectFilter)(txDirectFilters, "userId");
    if (filterUserId) {
    ...
    (0, query_1.applyDirectFilters)(where, txDirectFilters, {
        id: "string",
        type: "string",
        status: "string",
        currency: "string",
    ...
    const limit = Math.min(parseInt(query.limit) || parseInt(query.perPage) || 20, 100);
