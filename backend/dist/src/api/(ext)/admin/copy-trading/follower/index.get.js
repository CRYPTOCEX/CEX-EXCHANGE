                        ...
                        properties: {
                            ...
                            pagination: {
                                ...
                                properties: {
                                    ...
                                    totalItems: {
                                        type: "integer",
                                        description: "Total number of followers (alias of total, read by the data table)",
                                    },
                                },
                                required: ["total", "page", "limit", "totalPages", "totalItems"],
                            },
                        },
...
exports.default = async (data) => {
    ...
    const limit = parseInt(query.perPage) || parseInt(query.limit) || 10;
    ...
    const followerDirectFilters = (0, query_1.parseFilterParam)(query.filter, []);
    const filterUserId = (0, query_1.takeDirectFilter)(followerDirectFilters, "userId");
    if (filterUserId) {
