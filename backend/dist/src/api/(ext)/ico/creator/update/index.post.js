...
exports.default = async (data) => {
    ...
    // Authorization: only the offering's creator may post updates impersonating it.
    // Without this check any authenticated user could publish fake investor-facing updates.
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Verifying offering ownership");
    ...
    if (offering.userId !== user.id) {
        throw (0, error_1.createError)({ statusCode: 403, message: "You are not the creator of this offering" });
    }
