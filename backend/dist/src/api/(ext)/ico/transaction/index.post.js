...
exports.default = async (data) => {
    ...
    try {
        ...
        if (owner && owner.email) {
            ...
            console_1.logger.error("ICO_TRANSACTION", "Investment committed; confirmation email failed", emailError);
        }
        try {
        ...
        try {
            await (0, affiliate_1.processRewards)(user.id, amount, "ICO_CONTRIBUTION", offering.purchaseWalletCurrency, `ICO_CONTRIBUTION:ico_transaction:${transactionId}`, ctx);
        }
