...
exports.default = async (data) => {
    ...
    const updates = {};
    const isLocked = merchant.verificationStatus === "VERIFIED";
    const sameValue = (a, b) => (a !== null && a !== void 0 ? a : "") === (b !== null && b !== void 0 ? b : "");
    ...
    for (const field of verifiedFields) {
        if (body[field] !== undefined) {
            if (isLocked && !sameValue(body[field], merchant[field])) {
                throw (0, error_1.createError)({
                    statusCode: 403,
                    message: `Cannot update ${field}. Your account is verified. Please contact support to request changes.`,
                });
            }
            updates[field] = body[field];
        }
