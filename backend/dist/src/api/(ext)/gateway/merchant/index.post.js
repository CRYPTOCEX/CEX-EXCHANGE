...
exports.default = async (data) => {
    ...
    if (gatewaySettings.gatewayRequireKyc) {
        await (0, kyc_1.assertKycFeatureOrLegacy)(user.id, kyc_1.KYC_FEATURES.USE_GATEWAY, { requireVerified: true }, "register as a merchant");
    }
    ...
    const merchant = await db_1.models.gatewayMerchant.create({
        ...
        phone: body.phone
            ? `+${String(body.phone).replace(/\D/g, "").slice(0, 15)}`
            : null,
