...
exports.default = async (data) => {
    ...
    try {
        await (0, kyc_1.assertKycFeature)(user.id, kyc_1.KYC_FEATURES.WITHDRAW_FOREX, "withdraw from a forex account");
        ...
        const result = await db_1.sequelize.transaction(async (t) => {
            ...
            (0, denomination_1.assertLiveAccount)(account);
            ctx === null || ctx === void 0 ? void 0 : ctx.step("Checking the account's denomination");
            await (0, denomination_1.assertAccountDenomination)(account, { currency, walletType: type }, t);
            ...
            const limitCheck = (0, withdraw_limits_1.checkWithdrawLimits)(account, total, now);
            if (!limitCheck.allowed) {
                throw (0, error_1.createError)({ statusCode: 400, message: limitCheck.reason });
            }
            ...
            await account.update({ balance: updatedAccountBalance }, { transaction: t });
