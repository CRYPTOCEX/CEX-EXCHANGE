    ...
    try {
        ...
        switch (type) {
            ...
            case "SPOT":
                ...
                (_f = ctx === null || ctx === void 0 ? void 0 : ctx.step) === null || _f === void 0 ? void 0 : _f.call(ctx, "Calculating transaction fees");
                let fixedFee = 0;
                const provider = await exchange_1.default.getProvider().catch(() => null);
                if (chain && (provider === "binance" || provider === "kucoin")) {
                    try {
                        ...
                        if (exchange) {
                            ...
                            if (exchangeCurrency === null || exchangeCurrency === void 0 ? void 0 : exchangeCurrency.networks) {
                                fixedFee =
                                    ((_g = exchangeCurrency.networks[chain]) === null || _g === void 0 ? void 0 : _g.fee) ||
                                        ((_j = (_h = exchangeCurrency.networks[chain]) === null || _h === void 0 ? void 0 : _h.fees) === null || _j === void 0 ? void 0 : _j.withdraw) ||
                                        0;
                            }
                        }
                    }
                    catch (exchangeError) {
                        console_1.logger.warn("FOREX", `Could not read the ${provider} network fee for ${currency}/${chain}; ` +
                            `charging the percentage fee only: ${exchangeError === null || exchangeError === void 0 ? void 0 : exchangeError.message}`);
                    }
                }
        ...
        (_k = ctx === null || ctx === void 0 ? void 0 : ctx.success) === null || _k === void 0 ? void 0 : _k.call(ctx, `Transaction fees calculated successfully: ${taxAmount}`);
        return {
            currencyData,
            taxAmount,
            total,
