...
exports.default = async (data) => {
    ...
    const [activeInvestors, totalInvestedResult, completedInvestments, activeInvestments, winCountResult, totalCompletedResult, profitResult, featuredPlans, signals, recentCompletions, durations,] = await Promise.all([
        ...
        db_1.models.forexInvestment.findOne({
            attributes: [
                [(0, sequelize_1.fn)("SUM", (0, sequelize_1.literal)(money_1.SIGNED_PROFIT_SQL)), "totalProfit"],
                [
                    (0, sequelize_1.fn)("AVG", (0, sequelize_1.literal)("CASE WHEN amount > 0 THEN " +
    ...
    const { investedByCurrency, primaryInvested, mixedCurrencies } = (0, money_1.summarise)(await (0, money_1.investedByCurrency)());
