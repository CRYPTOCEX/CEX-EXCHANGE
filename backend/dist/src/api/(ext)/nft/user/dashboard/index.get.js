...
exports.default = async (data) => {
    ...
    try {
        const [ownedTokens, listingValues, favoritesCount, creator, salesStats, categoryDistribution, recentActivities, tokens,] = await Promise.all([
            ...
            db_1.models.nftFavorite.count({
                where: { userId: user.id }
            }),
            db_1.models.nftCreator.findOne({
                where: { userId: user.id }
            }),
