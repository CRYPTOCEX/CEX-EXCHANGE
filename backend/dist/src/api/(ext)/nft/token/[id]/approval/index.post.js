...
exports.default = async (data) => {
    ...
    const ownerWalletAddress = await (0, nft_auth_1.requireWallet)(user.id, "verify an approval transaction");
    try {
        ...
        const currentApprovalStatus = await approval_service_1.NFTApprovalService.checkTokenApproval(token.collection.contractAddress, token.blockchainTokenId, ownerWalletAddress, marketplaceAddress, token.collection.chain, token.collection.standard);
