...
exports.default = async (data) => {
    ...
    try {
        ...
        await (0, kyc_1.assertKycFeature)(user.id, kyc_1.KYC_FEATURES.CREATE_NFT, "mint an NFT");
        const minterActor = await (0, nft_auth_1.loadActor)(user.id);
        ...
        try {
            ...
            if (((_a = receipt.to) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== ((_b = collection.contractAddress) === null || _b === void 0 ? void 0 : _b.toLowerCase())) {
                throw (0, error_1.createError)({
                    statusCode: 400,
        ...
        const maxRoyaltyPercentage = (_c = settings.get('nftMaxRoyaltyPercentage')) !== null && _c !== void 0 ? _c : 10;
        ...
        const metadata = metadataUri ? null : {
            ...
            properties: {
                creator: {
                    name: (0, nft_auth_1.actorDisplayName)(minterActor),
                    address: minterActor.walletAddress
                },
                collection: {
        ...
        try {
            ...
            if (!creator) {
                const creatorUsername = minterActor.firstName
                    ? `${minterActor.firstName}${minterActor.lastName || ''}`.toLowerCase().replace(/\s+/g, '')
