        ...
        await db_1.sequelize.transaction(async (transaction) => {
            ...
            try {
                await wallet_1.walletService.release({
                    ...
                    description: `Release escrow ${escrowAmount} ${offer.currency} - NFT offer cancelled`,
                    metadata: {
                        offerId: offer.id,
                ...
                if ((releaseError === null || releaseError === void 0 ? void 0 : releaseError.name) === "DuplicateOperationError") {
                    ...
                    console_1.logger.warn("NFT_OFFER", `No escrow to release for offer ${offer.id} (likely legacy); continuing cancel`);
                }
                else {
                    throw releaseError;
                }
