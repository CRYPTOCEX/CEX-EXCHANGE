...
exports.default = async (data) => {
    ...
    try {
        ...
        if (!creator) {
            const creatorDisplayName = actor.firstName
        ...
        const [collectionsCount, tokensStatsRaw, salesStatsRaw, collections, recentSales, topTokens,] = await Promise.all([
        ...
        const response = {
            creator: {
                id: user.id,
                displayName: actor.firstName && actor.lastName ? `${actor.firstName} ${actor.lastName}` : null,
            ...
            collections: collections.map(collection => { var _a; return ({
                ...collection.toJSON(),
