...
exports.default = async (data) => {
    ...
    await (0, kyc_1.assertKycFeature)(user.id, kyc_1.KYC_FEATURES.SELL_NFT, "start an auction");
    ...
    try {
        ...
        const feePercent = (0, settlement_1.marketplaceFeePercent)(settings);
        ctx === null || ctx === void 0 ? void 0 : ctx.step("Deploying auction contract to blockchain");
        const deployResult = await auctionService.deployAuction(listing.token.collection.contractAddress, listing.token.blockchainTokenId, listing.price.toString(), ((_b = listing.reservePrice) === null || _b === void 0 ? void 0 : _b.toString()) || listing.price.toString(), ((_c = listing.minBidIncrement) === null || _c === void 0 ? void 0 : _c.toString()) || "0.01", auctionEndTime, listing.seller.walletAddress, feePercent, listing.token.collection.royaltyPercentage || 0, listing.seller.walletAddress);
