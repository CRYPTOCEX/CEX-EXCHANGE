...
const loadActor = async (userId) => {
    ...
    const record = await db_1.models.user.findByPk(userId, {
        attributes: [
            "id",
            "walletAddress",
            "firstName",
    ...
    return {
        id: record.id,
        walletAddress: (_a = record.walletAddress) !== null && _a !== void 0 ? _a : null,
        firstName: (_b = record.firstName) !== null && _b !== void 0 ? _b : null,
        lastName: (_c = record.lastName) !== null && _c !== void 0 ? _c : null,
        avatar: (_d = record.avatar) !== null && _d !== void 0 ? _d : null,
        createdAt: (_e = record.createdAt) !== null && _e !== void 0 ? _e : null,
    };
};
exports.loadActor = loadActor;
const requireWallet = async (userId, action) => {
    var _a;
    const actor = await (0, exports.loadActor)(userId);
    const address = (_a = actor.walletAddress) === null || _a === void 0 ? void 0 : _a.trim();
    if (!address) {
        throw (0, error_1.createError)({
            statusCode: 400,
            message: `Connect a wallet address in your profile to ${action}`,
        });
    }
    return address;
};
...
const actorDisplayName = (actor) => {
    var _a, _b;
    const name = `${(_a = actor === null || actor === void 0 ? void 0 : actor.firstName) !== null && _a !== void 0 ? _a : ""} ${(_b = actor === null || actor === void 0 ? void 0 : actor.lastName) !== null && _b !== void 0 ? _b : ""}`.trim();
    return name || "Unknown";
};
exports.actorDisplayName = actorDisplayName;
...
const isPlatformAdmin = async (userId) => {
    ...
    const record = await db_1.models.user.findByPk(userId, {
        ...
        include: [{ model: db_1.models.role, as: "role", attributes: ["id", "name"] }],
    });
    const name = (_a = record === null || record === void 0 ? void 0 : record.role) === null || _a === void 0 ? void 0 : _a.name;
    if (!name)
        return false;
    return ADMIN_ROLE_NAMES.has(String(name).toLowerCase().replace(/[\s_-]/g, ""));
};
