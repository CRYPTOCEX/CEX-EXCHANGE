...
exports.isChainNativeCurrency = isChainNativeCurrency;
...
function isChainNativeCurrency(chain, currency) {
    var _a;
    if (!currency || !chainConfigs)
        return false;
    const native = (_a = chainConfigs[chain]) === null || _a === void 0 ? void 0 : _a.currency;
    if (!native)
        return false;
    return String(currency).toUpperCase() === String(native).toUpperCase();
}
