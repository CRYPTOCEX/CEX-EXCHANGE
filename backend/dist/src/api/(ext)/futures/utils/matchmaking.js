...
const processMatchedOrders = async (buyOrder, sellOrder, currentOrderBook, bookUpdates, matchedPrice) => {
    if ([buyOrder, sellOrder].some(order => order.stopLossPrice != null || order.takeProfitPrice != null)) {
        throw Object.assign(new Error("Futures protective order settlement requires reconciliation"), { statusCode: 503 });
    }
