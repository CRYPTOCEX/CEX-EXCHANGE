...
exports.default = async (data) => {
    var _a, _b, _c, _d;
    (0, native_binary_1.assertNotBinaryOnNativeApp)(data, (((_a = data.query) === null || _a === void 0 ? void 0 : _a.marketType) || ((_b = data.query) === null || _b === void 0 ? void 0 : _b.type)), "remove a binary market");
    const { user, params, ctx } = data;
    if (!(user === null || user === void 0 ? void 0 : user.id)) {
        throw (0, error_1.createError)({ statusCode: 401, message: "Unauthorized" });
    }
    const symbol = decodeURIComponent(params.symbol);
    const marketType = (((_c = data.query) === null || _c === void 0 ? void 0 : _c.marketType) || ((_d = data.query) === null || _d === void 0 ? void 0 : _d.type)) === "BINARY" ? "BINARY" : "SPOT";
