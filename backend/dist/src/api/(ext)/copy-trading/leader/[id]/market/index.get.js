                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                marketType: {
                                    type: "string",
                                    enum: ["SPOT", "BINARY"],
                                    description: "Instrument class of this market",
                                },
                                ...
                                minQuote: {
                                    type: "number",
                                    description: "Minimum quote currency allocation; for BINARY markets this is the minimum stake budget",
                                },
                            },
                        },
                    },
...
exports.default = async (data) => {
    ...
    return (0, mobile_shape_1.shapeForClient)((0, native_binary_1.stripBinaryForNative)(markets, data), data);
};
