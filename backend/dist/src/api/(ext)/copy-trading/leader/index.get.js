...
exports.metadata = {
    ...
    parameters: [
        ...
        },
        {
            ...
            in: "query",
            required: false,
            schema: { type: "string", enum: ["SPOT", "BINARY"] },
            description: "Filter by offered instrument class (matches leaders offering that class or BOTH)",
        },
        {
            name: "minWinRate",
            in: "query",
...
exports.default = async (data) => {
    ...
    if ((0, session_1.isNativeAppRequest)(data)) {
        whereClause.tradingType = { [sequelize_1.Op.ne]: "BINARY" };
    }
    ...
    if (query.tradingType === "SPOT" || query.tradingType === "BINARY") {
        if ((0, session_1.isNativeAppRequest)(data) && query.tradingType === "BINARY") {
            throw (0, error_1.createError)({
                statusCode: 403,
                message: "Binary options are not available in the mobile app. Spot copy trading is unaffected.",
            });
        }
        whereClause.tradingType = (0, session_1.isNativeAppRequest)(data)
            ? { [sequelize_1.Op.in]: ["SPOT", "BOTH"] }
            : { [sequelize_1.Op.in]: [query.tradingType, "BOTH"] };
    }
    ...
    return (0, display_name_1.redactPublicNames)((0, mobile_shape_1.shapeForClient)((0, native_binary_1.stripBinaryForNative)(payload, data), data));
};
