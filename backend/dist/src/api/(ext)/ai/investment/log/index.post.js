...
exports.default = async (data) => {
    (0, mobile_forbidden_1.refuseOnNativeApp)(data, "ai-investment");
    const { user, body, ctx } = data;
    if (!(user === null || user === void 0 ? void 0 : user.id)) {
        throw (0, error_1.createError)({ statusCode: 401, message: "Unauthorized" });
    }
    await (0, kyc_1.assertKycFeature)(user.id, kyc_1.KYC_FEATURES.INVEST_AI, "open an AI investment");
    ...
    for (const [field, value] of [["currency", currency], ["pair", pair]]) {
        if (typeof value !== "string" || !/^[A-Za-z0-9._-]{1,32}$/.test(value)) {
            throw (0, error_1.createError)({
                statusCode: 400,
                message: `Invalid ${field}: expected a plain asset code with no separator`,
            });
        }
    }
    ...
    const investment = await db_1.sequelize.transaction(async (t) => {
        ...
        const snapshotRoiPercentage = (_b = (_a = plan.profitPercentage) !== null && _a !== void 0 ? _a : plan.defaultProfit) !== null && _b !== void 0 ? _b : 0;
        const snapshotResult = (_c = plan.defaultResult) !== null && _c !== void 0 ? _c : "DRAW";
        const investment = await db_1.models.aiInvestment.create({
            ...
            status: "ACTIVE",
            type: type || "SPOT",
            roiPercentage: snapshotRoiPercentage,
