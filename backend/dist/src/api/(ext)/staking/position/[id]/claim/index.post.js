...
exports.default = async (data) => {
    ...
    const recentClaims = userPositionIds.length > 0
        ? await db_1.models.stakingEarningRecord.count({
            where: {
                positionId: { [sequelize_1.Op.in]: userPositionIds },
                isClaimed: true,
                claimedAt: { [sequelize_1.Op.gte]: new Date(Date.now() - 3600000) },
            },
        })
        : 0;
    if (recentClaims >= 10) {
