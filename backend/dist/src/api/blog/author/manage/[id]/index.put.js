...
exports.default = async (data) => {
    ...
    return await db_1.sequelize
        ...
        if (typeof body.slug === "string" && body.slug.trim()) {
            const nextSlug = (0, utils_1.slugify)(body.slug);
            if (nextSlug && nextSlug !== slug) {
                ctx === null || ctx === void 0 ? void 0 : ctx.step("Checking for duplicate post slug");
                const clash = await db_1.models.post.findOne({
                    where: { slug: nextSlug, id: { [sequelize_1.Op.ne]: id } },
                    paranoid: false,
                    transaction,
                });
                if (clash)
        ...
        await (0, tags_1.syncPostTags)(existingPost.id, tags, transaction);
