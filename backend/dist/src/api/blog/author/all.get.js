...
exports.default = async (data) => {
    const { query } = data;
    return (0, display_name_1.withPublicPresence)((0, display_name_1.redactPublicNames)(await getAuthors(query.posts === "true", query.status)));
};
async function getAuthors(includePosts, status) {
    ...
    return authors.map((author) => (0, public_profile_1.withPublicProfile)(author.get({ plain: true })));
}
