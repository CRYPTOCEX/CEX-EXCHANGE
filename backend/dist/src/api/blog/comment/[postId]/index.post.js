...
exports.default = async (data) => {
    ...
    await (0, kyc_1.assertKycFeature)(user.id, kyc_1.KYC_FEATURES.COMMENT_BLOG, "comment");
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Checking comment settings");
    const cacheManager = cache_1.CacheManager.getInstance();
    const commentsOpen = await cacheManager.getSettingBool("enableComments", true);
    if (!commentsOpen) {
        ctx === null || ctx === void 0 ? void 0 : ctx.fail("Comments are disabled");
        return (0, error_1.createError)(403, "Comments are turned off on this blog");
    }
    const moderateComments = await cacheManager.getSettingBool("moderateComments", true);
    const content = (0, utils_1.sanitizeCommentContent)(body === null || body === void 0 ? void 0 : body.content);
    if (!content) {
