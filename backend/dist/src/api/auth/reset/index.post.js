...
exports.default = async (data) => {
    ...
    try {
        ...
        await (0, captcha_1.verifyCaptchaOrThrow)(body, "reset", (0, address_parser_1.requestClientIp)(data));
        ctx === null || ctx === void 0 ? void 0 : ctx.step(`Looking up user: ${email}`);
        const user = await db_1.models.user.findOne({ where: { email } });
        if (!user || (0, system_accounts_1.isSystemAccount)(user)) {
            ctx === null || ctx === void 0 ? void 0 : ctx.success(user
                ? "Password reset requested for a platform system account (neutral response, no token minted)"
                : "Password reset requested for non-existent email (neutral response)");
            return {
