...
exports.default = async (data) => {
    ...
    try {
        ...
        if (!user) {
            // Prevent email enumeration: return generic success message instead of 404.
            // Attackers cannot distinguish "email registered" from "email not registered" via this endpoint.
            ctx === null || ctx === void 0 ? void 0 : ctx.success(`Password reset response generated for ${email}`);
            return {
        ...
        try {
            ...
            // Return same generic message as the user-not-found branch to prevent email enumeration.
            return {
                message: "If an account exists for this email, password reset instructions have been sent.",
            };
        }
