...
exports.metadata = {
    ...
    requiresAuth: false,
    middleware: ["emailVerificationCheck"],
    logModule: "EMAIL",
...
exports.default = async (data) => {
    const { body, ctx } = data;
    const { token } = body;
    return (0, exports.verifyEmailTokenQuery)(token, ctx, data);
};
const verifyEmailTokenQuery = async (token, ctx, req) => {
    try {
        ...
        if ((0, system_accounts_1.isSystemAccount)(user)) {
            ctx === null || ctx === void 0 ? void 0 : ctx.fail("Verification code resolved to a platform system account");
            throw (0, error_1.createError)({
                statusCode: 404,
                message: "Token not found or expired",
            });
        ...
        void (0, user_activity_1.recordUserActivity)({
            ...
            description: user.email || "Email address confirmed",
            severity: "success",
            req,
        });
