...
exports.default = async (data) => {
    ...
    try {
        ...
        await (0, captcha_1.verifyCaptchaOrThrow)(body, "login", (0, address_parser_1.requestClientIp)(data));
        ...
        if (await handleEmailVerificationIfRequired(user)) {
...
async function handleTwoFactorAuthentication(user, ctx) {
    ...
    try {
        ...
        console_1.logger.error("AUTH", `2FA code delivery failed for ${user.email} (${type}): ${deliveryError}`);
