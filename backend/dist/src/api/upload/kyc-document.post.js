...
exports.default = async (data) => {
    ...
    try {
        ...
        // CSPRNG-derived unguessable suffix prevents enumeration of KYC documents.
        const cryptoForFilename = require("crypto");
        const randomString = cryptoForFilename.randomBytes(16).toString("hex");
