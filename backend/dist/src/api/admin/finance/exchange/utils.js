...
exports.standardizeBitgetData = exports.standardizeGateData = exports.standardizeMexcData = exports.standardizeBybitData = exports.standardizeBinanceUsData = exports.standardizeOkxData = exports.standardizeXtData = exports.standardizeKucoinData = exports.standardizeBinanceData = void 0;
...
const standardizeCcxtNetwork = (item) => {
    var _a, _b, _c, _d, _e, _f;
...
const standardizeFromUnifiedNetworks = (data) => {
    if (!data || typeof data !== "object" || Array.isArray(data))
        return [];
    const result = [];
...
const standardizeBinanceUsData = (data) => {
    return (0, exports.standardizeBinanceData)(data);
};
exports.standardizeBinanceUsData = standardizeBinanceUsData;
const standardizeBybitData = (data) => standardizeFromUnifiedNetworks(data);
exports.standardizeBybitData = standardizeBybitData;
const standardizeMexcData = (data) => standardizeFromUnifiedNetworks(data);
exports.standardizeMexcData = standardizeMexcData;
const standardizeGateData = (data) => standardizeFromUnifiedNetworks(data);
exports.standardizeGateData = standardizeGateData;
const standardizeBitgetData = (data) => standardizeFromUnifiedNetworks(data);
