...
const TYPES_HIDDEN_FROM_GLOBAL_LIST = [
    "DEPOSIT",
    "WITHDRAW",
    "INCOMING_TRANSFER",
    "BINARY_ORDER",
...
function isUserScoped(filterParam) {
...
exports.default = async (data) => {
    const { query } = data;
    const scopedToOneUser = isUserScoped(query.filter);
    return (0, query_1.getFiltered)({
        model: db_1.models.transaction,
        where: scopedToOneUser
            ? {}
            : { type: { [sequelize_1.Op.notIn]: TYPES_HIDDEN_FROM_GLOBAL_LIST } },
        query,
