...
exports.metadata = {
    ...
    logTitle: "Update binary settings",
};
exports.default = async (data) => {
    ...
    try {
        const binaryStatus = (_d = (_c = body.binaryStatus) !== null && _c !== void 0 ? _c : (_a = body.global) === null || _a === void 0 ? void 0 : _a.enabled) !== null && _d !== void 0 ? _d : true;
        const binaryPracticeStatus = (_f = (_e = body.binaryPracticeStatus) !== null && _e !== void 0 ? _e : (_b = body.global) === null || _b === void 0 ? void 0 : _b.practiceEnabled) !== null && _f !== void 0 ? _f : true;
        ...
        await (0, binary_settings_cache_1.invalidateBinarySettingsCache)();
