...
exports.default = async (data) => {
    ...
    Object.values(currencies).forEach((currency) => {
        ...
        if (provider === "binance") {
        ...
        else if (provider === "binanceus") {
            standardizedNetworks = (0, utils_1.standardizeBinanceUsData)(currency.networks || {});
        }
            ...
            standardizedNetworks = (0, utils_1.standardizeBybitData)(currency.networks || {});
        }
        else if (provider === "mexc") {
            standardizedNetworks = (0, utils_1.standardizeMexcData)(currency.networks || {});
        }
        else if (provider === "gate") {
            standardizedNetworks = (0, utils_1.standardizeGateData)(currency.networks || {});
        }
        else if (provider === "bitget") {
            standardizedNetworks = (0, utils_1.standardizeBitgetData)(currency.networks || {});
        }
