...
exports.metadata = {
    ...
    responses: {
        ...
        400: {
            description: "Bad Request - Invalid cron job name",
        },
        404: {
            description: "Cron job not found",
        },
        409: {
            description: "Conflict - a run of this cron job is already in progress",
        },
        500: {
...
exports.default = async (data) => {
    ...
    try {
        ...
        if (job.status === "running") {
            ...
            throw (0, error_1.createError)({
                statusCode: 409,
                message: `Cron job '${cronName}' is already running. Wait for the current run to finish before triggering it again.`,
            });
        }
        ctx === null || ctx === void 0 ? void 0 : ctx.step(`Triggering cron job '${cronName}'`);
        let success;
        try {
            success = await cronJobManager.triggerJob(cronName);
        }
        catch (error) {
            if ((error === null || error === void 0 ? void 0 : error.statusCode) === 503) {
                throw error;
            }
            ctx === null || ctx === void 0 ? void 0 : ctx.fail(`Cron job '${cronName}' failed: ${error === null || error === void 0 ? void 0 : error.message}`);
            throw (0, error_1.createError)({
                statusCode: 500,
                message: `Cron job '${cronName}' ran but failed: ${error === null || error === void 0 ? void 0 : error.message}`,
            });
        }
        if (success) {
            ...
            ctx === null || ctx === void 0 ? void 0 : ctx.warn(`Cron job '${cronName}' refused to trigger — a run is already in progress`);
            throw (0, error_1.createError)({
                statusCode: 409,
                message: `Cron job '${cronName}' was not triggered because a run is already in progress. Wait for the current run to finish and try again.`,
            });
        }
    }
    catch (error) {
