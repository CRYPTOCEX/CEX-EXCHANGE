...
exports.default = async (data) => {
    ...
    try {
        ...
        const { describeSmsConfiguration } = await Promise.resolve().then(() => __importStar(require("@b/services/notification/providers/sms/resolve")));
        ...
        const settings = {
            channels: {
                ...
                sms: {
                    ...
                    provider: smsConfig.baseProvider,
                    configured: smsConfig.baseConfigured,
                    otpProvider: smsConfig.otpProvider,
                    otpConfigured: smsConfig.otpConfigured,
                },
                push: {
            ...
            providers: {
                ...
                twilio: {
                    configured: smsConfig.providers.twilio,
                },
                msg91: {
                    configured: smsConfig.providers.msg91,
                },
                vapid: {
                    configured: hasVapid,
