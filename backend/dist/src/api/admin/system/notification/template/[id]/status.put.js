...
exports.default = async (data) => {
    ...
    const result = await Promise.all([
        (0, query_1.updateStatus)("notificationTemplate", id, email, "email"),
        (0, query_1.updateStatus)("notificationTemplate", id, sms, "sms"),
        (0, query_1.updateStatus)("notificationTemplate", id, push, "push"),
    ]).then((results) => ({
