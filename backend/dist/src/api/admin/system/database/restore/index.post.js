...
exports.default = async (data) => {
    ...
    try {
        ...
        if (/[\\/]|\.\./.test(backupFile) || !backupFile.endsWith(".sql")) {
            throw (0, error_1.createError)({ statusCode: 400, message: "Invalid backup file name" });
        }
        const baseDir = path_1.default.resolve(process.cwd(), "backup");
        const backupPath = path_1.default.resolve(baseDir, backupFile);
        if (!(0, validation_1.validatePathSecurity)(backupPath, baseDir)) {
            throw (0, error_1.createError)({ statusCode: 400, message: "Path escapes backup directory" });
        }
