...
exports.operatorMap = {
    ...
    like: (item, key, value) => { var _a; return String((_a = item[key]) !== null && _a !== void 0 ? _a : "").toLowerCase().includes(String(value !== null && value !== void 0 ? value : "").toLowerCase()); },
    notLike: (item, key, value) => { var _a; return !String((_a = item[key]) !== null && _a !== void 0 ? _a : "").toLowerCase().includes(String(value !== null && value !== void 0 ? value : "").toLowerCase()); },
    ...
    regexp: (item, key, value) => { var _a; return String((_a = item[key]) !== null && _a !== void 0 ? _a : "").toLowerCase().includes(String(value !== null && value !== void 0 ? value : "").toLowerCase()); },
    notRegexp: (item, key, value) => { var _a; return !String((_a = item[key]) !== null && _a !== void 0 ? _a : "").toLowerCase().includes(String(value !== null && value !== void 0 ? value : "").toLowerCase()); },
};
exports.mediaCache = [];
