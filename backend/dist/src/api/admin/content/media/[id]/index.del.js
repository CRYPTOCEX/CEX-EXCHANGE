...
exports.default = async (data) => {
    ...
    const sanitizedPath = (0, validation_1.sanitizeUserPath)(imagePath.replace(/_/g, "/")).replace(/\//g, path_1.sep);
    const fullPath = (0, path_1.join)(utils_1.publicDirectory, sanitizedPath);
    if (!(0, validation_1.validatePathSecurity)((0, path_1.resolve)(fullPath), (0, path_1.resolve)(utils_1.publicDirectory))) {
        ctx === null || ctx === void 0 ? void 0 : ctx.fail("Invalid file path");
        throw (0, error_1.createError)({ statusCode: 400, message: "Invalid file path" });
    }
    try {
