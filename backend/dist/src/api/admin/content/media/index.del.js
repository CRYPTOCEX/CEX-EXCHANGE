...
exports.default = async (data) => {
    ...
    for (const imagePath of ids) {
        try {
            const rel = (0, validation_1.sanitizeUserPath)(imagePath.replace(/_/g, "/"));
            const fullPath = (0, path_1.join)(utils_1.publicDirectory, rel);
            if (!(0, validation_1.validatePathSecurity)(fullPath, utils_1.publicDirectory)) {
                ctx === null || ctx === void 0 ? void 0 : ctx.fail("Invalid image path");
                throw (0, error_1.createError)({ statusCode: 400, message: "Invalid image path" });
            }
