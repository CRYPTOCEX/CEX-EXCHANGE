...
exports.default = async (data) => {
    ...
    if (!authenticatedUser || ((_a = authenticatedUser.role) === null || _a === void 0 ? void 0 : _a.name) !== "Super Admin") {
        throw (0, error_1.createError)({
            statusCode: 403,
            message: "Forbidden - Only Super Admins can sync role permissions",
        });
    }
    const targetRole = await db_1.models.role.findByPk(data.params.id);
    if (!targetRole) {
    ...
    if (targetRole.name === "Super Admin") {
        throw (0, error_1.createError)({
            statusCode: 403,
            message: "Forbidden - Cannot modify the Super Admin role",
        });
    }
