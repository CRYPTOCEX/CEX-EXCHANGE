...
const decision_1 = require("../../application/decision");
exports.metadata = {
            ...
            "application/json": {
                schema: {
                    ...
                    properties: {
                        ...
                        applyDecision: {
                            type: "boolean",
                            description: "Write the service's verdict onto the application. Defaults to false: the result is recorded for a human to review, and the application keeps its current status. When true the applicant is emailed and the decision is written to their activity feed, exactly as for a manual review.",
                        },
                    },
...
exports.default = async (data) => {
    ...
    try {
        const { id } = params;
        const { applicationId, applyDecision } = body;
        if (!applicationId) {
        ...
        const suggestedStatus = verificationResponse.status === "VERIFIED"
            ? "APPROVED"
            : verificationResponse.status === "FAILED"
                ? "REJECTED"
                : "PENDING";
        let decisionApplied = false;
        if (applyDecision === true && suggestedStatus !== "PENDING") {
            ...
            ctx === null || ctx === void 0 ? void 0 : ctx.step("Recording verification result for review");
        }
