...
exports.default = async (data) => {
    ...
    const requested = query.limit === undefined ? MAX_LIMIT_DEFAULT : Number(query.limit);
    const limit = Number.isFinite(requested) && requested >= MIN_LIMIT
    ...
    try {
        ...
        const name = String(((_a = error === null || error === void 0 ? void 0 : error.constructor) === null || _a === void 0 ? void 0 : _a.name) || "");
        if (name === "BadSymbol" || name === "MarketNotFound") {
            throw (0, error_1.createError)(404, `Market ${symbol} is not available`);
        }
