...
exports.default = async (data) => {
    (0, mobile_forbidden_1.refuseOnNativeApp)(data, "binary");
    const { user, body, ctx, headers } = data;
    if (!(user === null || user === void 0 ? void 0 : user.id))
        throw (0, error_1.createError)({ statusCode: 401, message: "Unauthorized" });
    const { isDemo } = body;
    const isDemoOrder = isDemo === true || isDemo === 1 || isDemo === "true" || isDemo === "1";
    ...
    if (isDemoOrder && !binaryPracticeStatus) {
        throw (0, error_1.createError)({
            statusCode: 403,
    ...
    if (!isDemoOrder) {
        await (0, kyc_1.assertKycFeature)(user.id, kyc_1.KYC_FEATURES.BINARY_TRADING, "trade binary options");
    }
    ...
    if (/^ct_/i.test(idempotencyKey)) {
        throw (0, error_1.createError)({
            statusCode: 400,
            message: "Invalid idempotency-key: the 'ct_' prefix is reserved.",
        });
    }
    ...
    try {
        ...
        const o = order;
        if (!o.isDemo) {
            (0, safe_imports_1.triggerCopyTradingBinaryOrderCreated)({
                orderId: o.id,
                userId: user.id,
                symbol: o.symbol,
                side: o.side,
                ...
                barrier: o.barrier != null ? Number(o.barrier) : undefined,
                strikePrice: o.strikePrice != null ? Number(o.strikePrice) : undefined,
                payoutPerPoint: o.payoutPerPoint != null ? Number(o.payoutPerPoint) : undefined,
                profitPercentage: o.profitPercentage != null ? Number(o.profitPercentage) : undefined,
                isDemo: o.isDemo,
            }).catch(() => {
            });
        }
