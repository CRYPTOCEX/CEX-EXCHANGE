...
exports.default = async (data) => {
    ...
    try {
        ...
        const result = await BinaryOrderService_1.BinaryOrderService.cancelOrder(user.id, id);
        ctx === null || ctx === void 0 ? void 0 : ctx.success(`Cancelled binary order on ${order.symbol}${(result === null || result === void 0 ? void 0 : result.penaltyApplied) ? ` with ${result.penaltyApplied}% penalty` : ''}`);
    }
    catch (error) {
