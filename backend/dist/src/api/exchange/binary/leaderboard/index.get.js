...
exports.default = async (data) => {
    ...
    try {
        ...
        const traders = traderStats.map((stat, index) => {
            ...
            const displayName = (0, display_name_1.publicDisplayName)({ username: user === null || user === void 0 ? void 0 : user.username }, generateAnonymousName(firstName, lastName, stat.userId));
            return {
                rank: index + 1,
