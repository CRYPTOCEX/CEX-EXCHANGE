...
const BROWSABLE_UPLOAD_DIRS = new Set([
    "blog-posts",
    "blog",
    "editor",
]);
exports.metadata = {
    summary: "Fetches media files a user may browse",
    description: "Lists uploaded images from the directories a non-admin user is allowed to browse (blog and editor images). A directory must be named; private upload directories are never listed.",
    ...
    parameters: [
        ...constants_1.crudParameters,
        {
            ...
            in: "query",
            required: true,
            description: "The upload directory to list. Must be one of the browsable directories.",
            schema: { type: "string", enum: [...BROWSABLE_UPLOAD_DIRS] },
        },
    ],
    responses: {
        200: {
...
exports.default = async (data) => {
    ...
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Validating the requested directory");
    const uploadDir = typeof query.uploadDir === "string" ? query.uploadDir : "";
    if (!uploadDir) {
        ctx === null || ctx === void 0 ? void 0 : ctx.fail("No upload directory specified");
        throw (0, error_1.createError)({
            statusCode: 400,
            message: "An upload directory must be specified.",
        });
    }
    if (!BROWSABLE_UPLOAD_DIRS.has(uploadDir)) {
        ctx === null || ctx === void 0 ? void 0 : ctx.fail(`Directory not browsable: ${uploadDir}`);
        throw (0, error_1.createError)({
            statusCode: 403,
            message: "That upload directory cannot be browsed.",
        });
    }
