...
exports.default = async (data) => {
    ...
    // CSPRNG: read 4 bytes, mod 900000, add 100000 — 6-digit OTP with cryptographic entropy.
    const cryptoMod = require("crypto");
    const code = (100000 + (cryptoMod.randomBytes(4).readUInt32BE(0) % 900000)).toString();
