...
exports.default = async (data) => {
    ...
    if (!body || typeof body !== "object" || Array.isArray(body)) {
        ctx === null || ctx === void 0 ? void 0 : ctx.fail("Invalid request body");
        throw (0, error_1.createError)({
            statusCode: 400,
            message: "Request body must be an object with levelId and fields",
        });
    }
    ...
    try {
        ...
        const rejected = await db_1.models.kycApplication.findOne({
            where: { userId: user.id, levelId, status: "REJECTED" },
        });
        let newApplication;
        if (rejected) {
            ctx === null || ctx === void 0 ? void 0 : ctx.step("Reusing the rejected application row for this level");
            ...
            newApplication = await db_1.models.kycApplication.create({
                userId: user.id,
                levelId,
                data: fields,
                status: "PENDING",
        ...
        void (0, user_activity_1.recordUserActivity)({
            ...
            description: levelRecord.name
                ? `${levelRecord.name} (Level ${levelRecord.level})`
