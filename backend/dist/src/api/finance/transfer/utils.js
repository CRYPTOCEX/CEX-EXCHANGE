...
exports.getTransferFeePercentage = getTransferFeePercentage;
...
function getTransferFeePercentage(settings) {
    var _a;
    const raw = (_a = settings.get("walletTransferFee")) !== null && _a !== void 0 ? _a : settings.get("walletTransferFeePercentage");
...
async function sendTransferEmails(user, toUser, fromWallet, toWallet, amount, transaction) {
    ...
    try {
        ...
        await (0, notifications_1.createNotification)({
            ...
            message: `You received ${amount} ${toWallet.currency} from ${(_a = user.firstName) !== null && _a !== void 0 ? _a : "another user"}`,
            link: "/finance",
        });
    }
    catch (error) {
