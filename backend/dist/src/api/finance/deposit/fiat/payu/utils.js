...
exports.PAYU_CONFIG = {
    ...
    CALLBACK_URL: process.env.APP_PAYU_CALLBACK_URL || '/finance/deposit?gateway=payu&status=returned',
    WEBHOOK_ENDPOINT: process.env.APP_PAYU_WEBHOOK_ENDPOINT || '/api/finance/deposit/fiat/payu/webhook',
    SUCCESS_URL: process.env.APP_PAYU_SUCCESS_URL || '/finance/deposit?gateway=payu&status=success',
    FAILURE_URL: process.env.APP_PAYU_FAILURE_URL || '/finance/deposit?gateway=payu&status=failed',
    CANCEL_URL: process.env.APP_PAYU_CANCEL_URL || '/finance/deposit?gateway=payu&status=cancelled',
    VERSION: '1.0',
};
