...
exports.default = async (data) => {
    ...
    try {
        ...
        if (((_a = paymentIntent.metadata) === null || _a === void 0 ? void 0 : _a.userId) !== String(user.id)) {
            ctx === null || ctx === void 0 ? void 0 : ctx.fail("Payment intent does not belong to caller");
            throw (0, error_1.createError)({
                statusCode: 403,
                message: "Payment intent does not belong to the authenticated user",
            });
        }
        ...
        const totalAmount = (0, utils_1.fromStripeAmount)(paymentIntent.amount, paymentIntent.currency);
        ...
        let newBalance = Number(wallet.balance) + depositAmount;
