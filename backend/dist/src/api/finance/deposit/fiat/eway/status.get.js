...
exports.default = async (data) => {
    ...
    try {
        ...
        if (access_code) {
            ...
            if (!transaction || !(0, utils_2.parseTransactionMetadata)(transaction.metadata).eway_transaction_id) {
                throw (0, error_1.createError)({ statusCode: 404, message: "Transaction not found or does not have eWAY transaction ID" });
            }
            ewayResponse = await (0, utils_1.makeEwayRequest)(`/Transaction/${(0, utils_2.parseTransactionMetadata)(transaction.metadata).eway_transaction_id}`, "GET");
        }
        ...
        return {
            success: true,
            data: {
                transaction_id: (_a = ewayResponse.TransactionID) === null || _a === void 0 ? void 0 : _a.toString(),
                ...
                amount: (_b = ewayResponse.Payment) === null || _b === void 0 ? void 0 : _b.TotalAmount,
                currency: (_c = ewayResponse.Payment) === null || _c === void 0 ? void 0 : _c.CurrencyCode,
