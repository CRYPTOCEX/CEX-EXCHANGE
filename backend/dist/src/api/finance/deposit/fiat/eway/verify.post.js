    ...
    try {
        ...
        const storedMetadata = (() => {
            ...
            try {
                ...
                console_1.logger.error("EWAY", `Unparseable metadata on transaction ${transaction.id}`);
                return {};
            }
        })();
        ...
        if (ewayResponse.Errors) {
            ...
            return {
                ...
                data: {
                    ...
                    currency: storedMetadata.currency,
        ...
        if (isSuccessful) {
            ...
            const currency = storedMetadata.currency || 'AUD';
            ...
            const depositResult = await (0, utils_2.processFiatDeposit)({
                ...
                amount: transaction.amount,
                fee: feeAmount,
                referenceId: ((_a = ewayResponse.TransactionID) === null || _a === void 0 ? void 0 : _a.toString()) || access_code,
                method: "EWAY",
        ...
        return {
            ...
            data: {
                ...
                amount: transaction.amount,
                currency: storedMetadata.currency,
                gateway_transaction_id: (_b = ewayResponse.TransactionID) === null || _b === void 0 ? void 0 : _b.toString(),
