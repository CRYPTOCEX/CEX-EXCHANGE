...
exports.PAYSAFE_CONFIG = {
    ...
    RETURN_URL: process.env.APP_PAYSAFE_RETURN_URL || '/finance/deposit?gateway=paysafe&status=returned',
    TIMEOUT: 30000,
    VERSION: 'v1',
};
...
function buildCancelUrl() {
    const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000';
    return `${baseUrl}/finance/deposit?gateway=paysafe&status=cancelled`;
}
function isTestMode() {
