...
exports.default = async (data) => {
    ...
    try {
        ...
        const checkoutUrl = (parsedMetadata === null || parsedMetadata === void 0 ? void 0 : parsedMetadata.checkoutUrl) || `${baseUrl}/finance/deposit`;
        const returnUrl = `${baseUrl}/finance/deposit?gateway=paysafe&status=returned`;
        return {
            success: true,
            data: {
