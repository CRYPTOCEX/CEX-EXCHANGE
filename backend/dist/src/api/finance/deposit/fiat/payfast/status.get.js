...
exports.default = async (data) => {
    ...
    try {
        ...
        const payfastData = (0, utils_2.parseTransactionMetadata)(transaction.metadata).payfast;
        if (!payfastData || !payfastData.pf_payment_id) {
            return {
                ...
                data: {
                    ...
                    currency: (0, utils_2.parseTransactionMetadata)(transaction.metadata).currency || 'ZAR',
