            ...
            [sequelize_1.Op.and]: [
                {
                    [sequelize_1.Op.or]: [
                        { idempotencyKey: null },
                        { idempotencyKey: { [sequelize_1.Op.notLike]: "eco_debit_%" } },
                    ],
                },
                {
                    [sequelize_1.Op.or]: [
                        { idempotencyKey: null },
                        { idempotencyKey: { [sequelize_1.Op.notLike]: "eco_refund_%" } },
                    ],
                },
                {
                    [sequelize_1.Op.or]: [
                        { idempotencyKey: null },
                        { idempotencyKey: { [sequelize_1.Op.notLike]: "admin_deposit_approve_%" } },
                    ],
                },
                {
                    [sequelize_1.Op.or]: [
                        { idempotencyKey: null },
                        { idempotencyKey: { [sequelize_1.Op.notLike]: "%_eco_chain" } },
                    ],
                },
            ],
        },
