...
exports.metadata = {
    summary: "Sends a withdrawal verification code",
    description: "Delivers a one-time code over the user's enrolled two-factor channel so a withdrawal can be confirmed. Authenticator-app users receive no message — they read the code from their app.",
    operationId: "startWithdrawVerification",
    tags: ["Wallets"],
    requiresAuth: true,
    middleware: ["withdrawVerificationSend"],
    logModule: "WITHDRAW_2FA",
    logTitle: "Send withdrawal verification code",
    responses: {
        200: {
...
exports.default = async (data) => {
    ...
    if (enrolled.type === "EMAIL") {
        ctx === null || ctx === void 0 ? void 0 : ctx.step("Queueing withdrawal verification email");
        try {
            ...
            console_1.logger.error("WITHDRAW_2FA", "Failed to queue verification email", error);
            throw (0, error_1.createError)({
                statusCode: 500,
                message: "Could not send the verification code. Please try again.",
            });
        }
        ctx === null || ctx === void 0 ? void 0 : ctx.success("Withdrawal verification code emailed");
        return {
            type: "EMAIL",
            delivered: true,
    ...
    ctx === null || ctx === void 0 ? void 0 : ctx.step("Sending withdrawal verification SMS");
    try {
        await (0, sms_1.sendSmsCode)(account.phone, otp, "WITHDRAW_OTP");
    }
    catch (error) {
        console_1.logger.error("WITHDRAW_2FA", "Failed to send verification SMS", error);
        throw (0, error_1.createError)({
            statusCode: 500,
            message: "Could not send the verification code. Please try again.",
        });
    }
    ctx === null || ctx === void 0 ? void 0 : ctx.success("Withdrawal verification code sent by SMS");
    return {
        type: "SMS",
        delivered: true,
