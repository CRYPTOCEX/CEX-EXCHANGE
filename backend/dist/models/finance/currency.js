    ...
    static initModel(sequelize) {
        return currency.init({
            ...
            price: {
                ...
                comment: "Units of this currency per 1 USD (e.g. NGN = 1365 means 1 USD = 1365 NGN). This is the inverse of the currency's USD price — use getFiatPriceInUSD() to convert.",
            },
            status: {
