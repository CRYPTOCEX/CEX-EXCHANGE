...
class depositGateway extends sequelize_1.Model {
    ...
    currencyScopedNumber(raw, currency) {
        let value = raw;
    ...
    getFixedFee(currency) {
        var _a;
        return (_a = this.currencyScopedNumber(this.fixedFee, currency)) !== null && _a !== void 0 ? _a : 0;
    }
    getPercentageFee(currency) {
        var _a;
        return (_a = this.currencyScopedNumber(this.percentageFee, currency)) !== null && _a !== void 0 ? _a : 0;
    }
    getMinAmount(currency) {
        var _a;
        return (_a = this.currencyScopedNumber(this.minAmount, currency)) !== null && _a !== void 0 ? _a : 0;
    }
