    ...
    static initModel(sequelize) {
        return notification.init({
            ...
            eventKey: {
                ...
                allowNull: true,
                comment: "Stable machine name of the event this notification announces, for deep links and push eligibility. NULL means the producer did not declare one; readers fall back to type/title.",
            },
            channels: {
                type: sequelize_1.DataTypes.JSON,
                allowNull: true,
