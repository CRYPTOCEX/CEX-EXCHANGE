    ...
    static initModel(sequelize) {
        return supportTicket.init({
            ...
            lastMessageAt: {
                ...
                allowNull: true,
                comment: "Time of the last non-system message. Derived from messages; the queue's sort key",
            },
            lastMessageFrom: {
                type: sequelize_1.DataTypes.STRING(8),
                allowNull: true,
                comment: "Sender of the last non-system message: client or agent. Null when the thread has none",
            },
