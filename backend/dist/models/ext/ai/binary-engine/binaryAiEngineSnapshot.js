    ...
    static initModel(sequelize) {
        return binaryAiEngineSnapshot.init({
            ...
            configData: {
                ...
                allowNull: true,
                get() {
                    const value = this.getDataValue("configData");
                    if (value == null)
                        return null;
            ...
            configSnapshot: {
                ...
                allowNull: false,
                get() {
                    const value = this.getDataValue("configSnapshot");
                    if (value == null)
                        return {};
                    if (typeof value === "string") {
                        try {
            ...
            performanceSnapshot: {
                ...
                allowNull: true,
                get() {
                    const value = this.getDataValue("performanceSnapshot");
                    if (value == null)
                        return null;
                    if (typeof value === "string") {
                        try {
            ...
            tierData: {
                ...
                allowNull: true,
                get() {
                    const value = this.getDataValue("tierData");
                    if (value == null)
                        return null;
                    if (typeof value === "string") {
                        try {
