        ...
        return binaryAiEngine.init({
            ...
            marketMakerId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "marketMakerId: Must be a valid UUID" },
                },
            },
            status: {
            ...
            correlationConfig: {
                ...
                allowNull: true,
                get() {
                    const value = this.getDataValue("correlationConfig");
                    if (value == null)
                        return null;
            ...
            allowedOrderTypes: {
                ...
                get() {
                    const value = this.getDataValue("allowedOrderTypes");
            ...
            mlModelWeights: {
                ...
                allowNull: true,
                get() {
                    const value = this.getDataValue("mlModelWeights");
                    if (value == null)
                        return null;
                    if (typeof value === "string") {
                        try {
