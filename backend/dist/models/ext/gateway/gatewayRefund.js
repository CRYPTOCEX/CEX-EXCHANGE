    ...
    static initModel(sequelize) {
        return gatewayRefund.init({
            ...
            paymentId: {
                ...
                allowNull: false,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "paymentId: Must be a valid UUID" },
                },
            },
            merchantId: {
                type: sequelize_1.DataTypes.UUID,
                allowNull: false,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "merchantId: Must be a valid UUID" },
                },
            },
            transactionId: {
                type: sequelize_1.DataTypes.UUID,
