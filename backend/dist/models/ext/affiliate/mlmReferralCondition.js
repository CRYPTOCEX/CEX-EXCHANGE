...
class mlmReferralCondition extends sequelize_1.Model {
    static initModel(sequelize) {
        return mlmReferralCondition.init({
            ...
            type: {
                type: sequelize_1.DataTypes.ENUM("DEPOSIT", "TRADE", "SPOT_TRADE", "BINARY_WIN", "INVESTMENT", "AI_INVESTMENT", "FOREX_INVESTMENT", "FOREX_TRADING", "ICO_CONTRIBUTION", "STAKING", "ECOMMERCE_PURCHASE", "P2P_TRADE", "NFT_TRADE", "COPY_TRADING", "FUTURES_TRADE", "TOKEN_PURCHASE"),
                allowNull: false,
                validate: {
                    isIn: {
                        args: [
            ...
            period: {
                ...
                validate: {
                    isIn: {
                        ...
                        msg: "period: Period must be one of DAILY, WEEKLY, MONTHLY",
                    },
                },
            },
        }, {
            ...
            indexes: [
                ...
                {
                    name: "mlmReferralConditionStatusIndex",
                    using: "BTREE",
                    fields: [{ name: "status" }],
                },
            ],
