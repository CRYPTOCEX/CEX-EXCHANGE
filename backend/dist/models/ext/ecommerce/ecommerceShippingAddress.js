        ...
        return ecommerceShippingAddress.init({
            ...
            orderId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "orderId: Order ID must be a valid UUID" },
                },
            },
            name: {
            ...
            phone: {
                ...
                validate: {
                    ...
                    is: {
                        args: ["^\\+[0-9]{7,15}$", ""],
                        msg: "phone: Must be in international E.164 format, e.g. +254711972926",
                    },
                },
            },
            street: {
