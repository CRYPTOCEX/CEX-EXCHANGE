        ...
        return p2pAdminActivity.init({
            ...
            relatedEntityId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "relatedEntityId must be a valid UUID" },
                },
            },
            relatedEntityName: {
            ...
            adminId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "adminId must be a valid UUID" },
                },
            },
        }, {
            sequelize,
