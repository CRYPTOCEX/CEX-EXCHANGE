        ...
        return p2pReview.init({
            ...
            reviewerId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "reviewerId must be a valid UUID" },
                },
            },
            revieweeId: {
                type: sequelize_1.DataTypes.UUID,
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "revieweeId must be a valid UUID" },
                },
            },
            tradeId: {
                type: sequelize_1.DataTypes.UUID,
