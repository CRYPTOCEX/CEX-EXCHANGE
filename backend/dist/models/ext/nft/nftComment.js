    ...
    static initModel(sequelize) {
        return nftComment.init({
            ...
            collectionId: {
                ...
                allowNull: true,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "collectionId: Must be a valid UUID" },
                },
            },
            userId: {
                type: sequelize_1.DataTypes.UUID,
            ...
            parentId: {
                ...
                allowNull: true,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "parentId: Must be a valid UUID" },
                },
            },
            content: {
