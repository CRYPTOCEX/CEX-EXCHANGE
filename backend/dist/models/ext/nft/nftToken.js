        ...
        return nftToken.init({
            ...
            attributes: {
                ...
                set(value) {
                    if (typeof value === "string") {
                        try {
                            this.setDataValue("attributes", JSON.parse(value));
                        }
                        catch (_a) {
                            this.setDataValue("attributes", null);
                        }
                        return;
                    }
                    this.setDataValue("attributes", value !== null && value !== void 0 ? value : null);
                },
            },
            metadataUri: {
                type: sequelize_1.DataTypes.STRING(1000),
            ...
            ownerId: {
                ...
                allowNull: true,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "ownerId: Owner ID must be a valid UUID" },
                },
            },
            creatorId: {
                type: sequelize_1.DataTypes.UUID,
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "creatorId: Creator ID must be a valid UUID" },
                },
            },
            mintedAt: {
            ...
            rarityScore: {
                ...
                get() {
                    const value = this.getDataValue("rarityScore");
