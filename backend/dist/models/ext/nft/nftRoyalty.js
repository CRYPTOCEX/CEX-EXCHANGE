        ...
        return nftRoyalty.init({
            ...
            saleId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "saleId: Sale ID must be a valid UUID" },
                },
            },
            tokenId: {
                type: sequelize_1.DataTypes.UUID,
            ...
            recipientId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "recipientId: Recipient ID must be a valid UUID" },
                },
            },
            amount: {
