    ...
    static initModel(sequelize) {
        return nftMarketplace.init({
            ...
            deployedBy: {
                ...
                allowNull: true,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "deployedBy: Must be a valid UUID" },
                },
            },
            feeRecipient: {
                type: sequelize_1.DataTypes.STRING(255),
            ...
            pausedBy: {
                ...
                allowNull: true,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "pausedBy: Must be a valid UUID" },
                },
            },
            version: {
                type: sequelize_1.DataTypes.STRING(50),
