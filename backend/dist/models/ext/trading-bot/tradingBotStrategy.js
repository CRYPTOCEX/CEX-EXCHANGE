        ...
        return tradingBotStrategy.init({
            ...
            creatorId: {
                ...
                validate: {
                    ...
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "creatorId: Must be a valid UUID" },
                },
            },
            name: {
            ...
            defaultConfig: {
                ...
                allowNull: false,
                get() {
                    const value = this.getDataValue("defaultConfig");
                    if (value == null)
                        return {};
                    if (typeof value === "string") {
                        try {
            ...
            customNodes: {
                ...
                allowNull: true,
                get() {
                    const value = this.getDataValue("customNodes");
                    if (value == null)
                        return null;
                    if (typeof value === "string") {
                        try {
            ...
            recommendedSymbols: {
                ...
                defaultValue: [],
                get() {
                    const value = this.getDataValue("recommendedSymbols");
                    if (value == null)
                        return [];
                    if (typeof value === "string") {
                        try {
