    ...
    static initModel(sequelize) {
        return postTag.init({
            ...
            postId: {
                ...
                allowNull: false,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "postId: Post ID must be a valid UUID" },
                },
            ...
            tagId: {
                ...
                allowNull: false,
                validate: {
                    isUUID: { args: model_validators_1.ANY_UUID_VERSION, msg: "tagId: Tag ID must be a valid UUID" },
                },
