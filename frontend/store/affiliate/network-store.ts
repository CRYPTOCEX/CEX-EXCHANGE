...
export interface NetworkData {
  ...
  /**
   * Which chain commissions actually walk. Always "SPONSOR" — placement and
   * spillover change the drawn tree, never who is paid.
   */
  commissionLine?: "SPONSOR";
  /**
   * BINARY only: where this member sits in the PLACEMENT tree, when spillover
   * has parked them under someone other than their sponsor. Null otherwise.
   */
  placementParent?: {
    id: string;
    firstName: string;
