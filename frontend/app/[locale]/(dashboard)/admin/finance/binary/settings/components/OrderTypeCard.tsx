      ...
      <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
        <div className="flex items-center gap-4 p-4">
          ...
          <div
            ...
            style={{ backgroundColor: typeInfo?.colorSoft }}
          >
            <Icon size={20} />
          </div>
            ...
            <div className="mt-4 pt-4 border-t">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label className="text-sm">{tCommon("live_mode")}</Label>
                </div>
              </div>
            </div>
            ...
            {config.profitPercentage > 95 && (
              <div className="flex items-start gap-2 mt-4 p-3 rounded-lg bg-warning/10 border border-warning/30">
                ...
                <div className="text-sm">
                  <p className="font-medium text-warning">{t("high_profit_warning")}</p>
                  <p className="text-muted-foreground">
                    {t("profit_over_95_may_not_be")}
                  </p>
                </div>
              </div>
            )}
