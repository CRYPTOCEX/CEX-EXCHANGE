...
export default function ExchangeProviderPage() {
  ...
  const exchangeDetails: Record<string, any> = {
    ...
    okx: {
      ...
      restrictedCountries:
        "United States, Cuba, Iran, North Korea, Syria, Crimea, Sevastopol, Bangladesh, Bolivia, Malaysia",
      description:
        "OKX is one of the world's largest cryptocurrency exchanges by daily trading volume, offering spot, derivatives, and DeFi services. Founded in 2017, OKX provides deep liquidity across hundreds of digital assets and supports multi-chain deposits and withdrawals.",
      color: "from-slate-700 to-zinc-900",
    },
    binanceus: {
      imgSrc: "/img/exchanges/binanceus.svg",
      supportedCountries: "Available U.S. States",
      link: "https://www.binance.us/state-restrictions",
      description:
        "Binance.US is the U.S.-regulated affiliate of Binance, offering compliant spot trading for residents of supported U.S. states. It mirrors Binance's matching engine while adhering to U.S. licensing and KYC requirements.",
      color: "from-yellow-400 to-amber-600",
    },
    bybit: {
      imgSrc: "/img/exchanges/bybit.jpg",
      restrictedCountries:
        "United States, Mainland China, Singapore, Quebec (Canada), Cuba, Iran, North Korea, Syria, Crimea",
      description:
        "Bybit is a leading cryptocurrency exchange founded in 2018, known for high-performance trading infrastructure, deep liquidity, and a robust spot/derivatives platform. It supports multi-chain deposits and withdrawals for hundreds of assets.",
      color: "from-amber-400 to-orange-600",
    },
    mexc: {
      imgSrc: "/img/exchanges/mexc.jpg",
      restrictedCountries:
        "United States, Canada, Mainland China, Cuba, Iran, North Korea, Syria, Crimea, Sevastopol",
      description:
        "MEXC Global is a popular cryptocurrency exchange offering spot, futures, and ETF trading across thousands of digital assets. Founded in 2018, MEXC is known for listing emerging tokens quickly and providing high-leverage derivatives products.",
      color: "from-cyan-400 to-sky-600",
    },
    gate: {
      imgSrc: "/img/exchanges/gateio.jpg",
      restrictedCountries:
        "United States, Cuba, Iran, North Korea, Syria, Crimea",
      description:
        "Gate.io is one of the longest-running cryptocurrency exchanges, founded in 2013. It offers spot, margin, futures, and options trading across thousands of digital assets, with broad multi-chain support for deposits and withdrawals.",
      color: "from-emerald-400 to-teal-600",
    },
    bitget: {
      imgSrc: "/img/exchanges/bitget.jpg",
      restrictedCountries:
        "United States, Canada (Ontario), Mainland China, Cuba, Iran, North Korea, Syria, Crimea",
      description:
        "Bitget is a global cryptocurrency exchange founded in 2018, recognized for its copy-trading platform, reliable spot/derivatives trading, and multi-network deposit/withdrawal support across major blockchains.",
