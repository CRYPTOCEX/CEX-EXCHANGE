...
export default function TransferDetailClient() {
   ...
   * `isLoading`: completing or rejecting refetches, and blanking a record the
  ...
  const userInitials = userName
    ...
    .join("")
    .toUpperCase();
  const isEditable = ["PENDING", "PROCESSING"].includes(
    transaction?.status ?? ""
  );
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 py-6">
        ...
        {/*
          ...
          "there is no such transfer" is a CONCLUSION — only reachable once the
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  <Loadable
                    loading={awaitingRecord}
                    placeholder={t("this_transfer_is_awaiting_review")}
                  >
          ...
          <Card className=" bg-card border border-border-strong">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <CardContent className="px-6 pb-6 pt-4">
                  ...
                  {metadata.fromWallet && metadata.toWallet && (
                    <div className="bg-card/70 dark:bg-muted/70 backdrop-blur-sm rounded-xl p-6 border border-border/60 dark:border-border-strong/60">
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                        <div className="flex-1 bg-primary/30 rounded-xl p-4 text-center border border-primary/50">
                        ...
                        <div className="flex-1 bg-success/30 rounded-xl p-4 text-center border border-success/50">
                          <p className="text-xs font-medium text-muted-foreground mb-1">
                            {t("to_wallet")}
                          </p>
                          <p className="font-mono text-sm font-medium">
                ...
                <TabsContent value="manage" className="mt-0 space-y-6">
                  {!isEditable ? (
                    /*
                      ...
                      CONCLUSIONS about the transfer's status, so they wait.
                ...
                {/* Audit — who touched this transfer and why, plus the balance
