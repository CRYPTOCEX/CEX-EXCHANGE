 ...
 * and the footer's brand line, legal line and link list is exactly that job —
 * an owner who can repaint every surface is not a different person from the one
 * who decides what the footer says.
 *
 * A fresh string (`access.footer`) would have been the tidier-looking choice and
