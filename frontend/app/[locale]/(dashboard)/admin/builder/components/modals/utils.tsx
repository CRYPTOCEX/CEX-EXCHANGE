...
export const SearchInput = ({ placeholder, value, onChange }) => (
  <div className="relative">
    <Search className="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground text-muted-foreground" />
    <Input
      placeholder={placeholder}
      className="pl-8 bg-muted border-border-strong text-foreground dark:placeholder:text-muted-foreground"
      value={value}
      onChange={onChange}
    />
  </div>
