    ...
    <div className="space-y-3">
      <div className="space-y-1">
        ...
        <LabeledSelect
          ...
          options={[
            { value: "all", label: t("all_properties") },
            { value: "transform", label: t("transform_only") },
            { value: "opacity", label: t("opacity_only") },
            { value: "background", label: t("background_only") },
      ...
      <div className="mt-2 p-3 border rounded-md bg-muted flex justify-center items-center h-16">
        <div
          className={`h-8 w-8 bg-primary rounded-md ${settings.hoverEffect ? "hover-preview" : ""}`}
          style={
            {
              transitionProperty:
                settings.transitionProperty === "custom"
      ...
      <style jsx global>{`
        ...
        .hover-preview[data-hover-effect="glow"]:hover {
          box-shadow: 0 0 calc(15px * var(--hover-intensity))
            hsl(var(--primary) / calc(0.5 * var(--hover-intensity)));
        }
