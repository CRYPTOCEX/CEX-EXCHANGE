      ...
      {scrollSettings.enableScrollEffects && (
        <>
          ...
          <div className="space-y-2 border-t pt-2">
            ...
            <div className="space-y-1">
              <Label className="text-xs">{tCommon("threshold")}</Label>
              <SliderWithInput
          ...
          <div className="space-y-2">
            ...
            <div className="border rounded-md bg-muted h-40 flex items-center justify-center p-4">
              <div
                className="bg-primary text-primary-foreground rounded-md p-4 w-32 h-32 flex items-center justify-center"
