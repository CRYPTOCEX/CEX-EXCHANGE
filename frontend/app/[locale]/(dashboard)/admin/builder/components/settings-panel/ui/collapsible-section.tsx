...
export function CollapsibleSection({
  ...
  return (
    <div className="border-b border-border w-full overflow-hidden">
      <button
        className="flex w-full items-center justify-between py-2 px-4 text-left text-sm font-medium text-muted-foreground hover:text-foreground focus:outline-none"
      ...
      >
        ...
        <ChevronDown
          className={cn(
            "h-4 w-4 text-subtle-foreground transition-transform duration-150",
            isOpen ? "rotate-180" : ""
          )}
        />
      </button>
