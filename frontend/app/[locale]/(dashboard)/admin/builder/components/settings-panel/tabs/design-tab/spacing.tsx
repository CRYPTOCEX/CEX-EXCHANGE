  ...
  return (
    <div className="space-y-3 p-4 max-w-full">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <Button
              ...
              title={
                linkedPaddingVertical
                  ? t("unlink_vertical_padding")
                  : t("link_vertical_padding")
              }
            >
              {linkedPaddingVertical ? (
            ...
            <Button
              ...
              title={
                linkedPaddingHorizontal
                  ? t("unlink_horizontal_padding")
                  : t("link_horizontal_padding")
              }
            >
              {linkedPaddingHorizontal ? (
        ...
        <div className="relative bg-muted border rounded-md p-6 mb-2">
          <div className="absolute inset-x-0 top-0 h-6 bg-primary/30 flex items-center justify-center">
            <span className="text-xs text-primary">
              {settings?.paddingTop || 0}
              px
            </span>
          </div>
          <div className="absolute inset-y-0 right-0 w-6 bg-primary/30 flex items-center justify-center">
            <span className="text-xs text-primary transform rotate-90">
              {settings?.paddingRight || 0}
              px
            </span>
          </div>
          <div className="absolute inset-x-0 bottom-0 h-6 bg-primary/30 flex items-center justify-center">
            <span className="text-xs text-primary">
              {settings?.paddingBottom || 0}
              px
            </span>
          </div>
          <div className="absolute inset-y-0 left-0 w-6 bg-primary/30 flex items-center justify-center">
            <span className="text-xs text-primary transform -rotate-90">
              {settings?.paddingLeft || 0}
              px
            </span>
          </div>
          <div className="h-full w-full border-2 border-dashed border-border-strong flex items-center justify-center">
            <span className="text-xs text-subtle-foreground">{tCommon("content")}</span>
          </div>
        </div>
      ...
      <div className="space-y-2 mt-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <Button
              ...
              title={
                linkedMarginVertical
                  ? t("unlink_vertical_margin")
                  : t("link_vertical_margin")
              }
            >
              {linkedMarginVertical ? (
                <Link2 className="h-3.5 w-3.5 rotate-90" />
            ...
            <Button
              ...
              title={
                linkedMarginHorizontal
                  ? t("unlink_horizontal_margin")
                  : t("link_horizontal_margin")
              }
            >
              {linkedMarginHorizontal ? (
                <Link2 className="h-3.5 w-3.5" />
        ...
        <div className="relative bg-muted border rounded-md p-6 mb-2">
          <div className="absolute inset-x-0 top-0 h-6 bg-success/30 flex items-center justify-center">
            <span className="text-xs text-success">
              {settings?.marginTop || 0}
              px
            </span>
          </div>
          <div className="absolute inset-y-0 right-0 w-6 bg-success/30 flex items-center justify-center">
            <span className="text-xs text-success transform rotate-90">
              {settings?.marginRight || 0}
              px
            </span>
          </div>
          <div className="absolute inset-x-0 bottom-0 h-6 bg-success/30 flex items-center justify-center">
            <span className="text-xs text-success">
              {settings?.marginBottom || 0}
              px
            </span>
          </div>
          <div className="absolute inset-y-0 left-0 w-6 bg-success/30 flex items-center justify-center">
            <span className="text-xs text-success transform -rotate-90">
          ...
          <div className="h-full w-full border-2 border-dashed border-border-strong flex items-center justify-center">
            <span className="text-xs text-subtle-foreground">{tCommon("element")}</span>
          </div>
        </div>
