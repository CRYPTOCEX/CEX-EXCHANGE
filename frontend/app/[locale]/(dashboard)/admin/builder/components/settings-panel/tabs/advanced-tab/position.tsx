    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground mt-1">
          {positionType === "static" &&
            t("default_positioning_follows_document_flow")}
          {positionType === "relative" &&
            t("positioned_relative_to_its_normal_position")}
          {positionType === "absolute" &&
            t("positioned_relative_to_nearest_positioned_ancestor")}
          {positionType === "fixed" && t("positioned_relative_to_the_viewport")}
          {positionType === "sticky" && t("positioned_based_on_scroll_position")}
        </p>
      </div>
      ...
      {positionType !== "static" && (
        <div className="flex border-b">
          <Button
            variant="ghost"
            size="sm"
            className={`rounded-none border-b-2 ${activeTab === "basic" ? "border-primary" : "border-transparent"}`}
          ...
          <Button
            variant="ghost"
            size="sm"
            className={`rounded-none border-b-2 ${activeTab === "visual" ? "border-primary" : "border-transparent"}`}
      ...
      {positionType !== "static" && activeTab === "basic" && (
        <div className="space-y-4">
          ...
          {/* Unit Selector */}
          <div className="space-y-1">
            <Label className="text-xs">{tCommon("unit")}</Label>
      ...
      {positionType !== "static" && activeTab === "visual" && (
        <div className="space-y-4">
          <div
            ref={previewRef}
            className="relative border rounded-md bg-muted h-64 overflow-hidden"
          >
            {/* Parent container representation */}
            <div className="absolute inset-4 border-2 border-dashed border-border-strong rounded-md flex items-center justify-center">
              ...
              <div
                ref={elementRef}
                className={`absolute bg-primary text-primary-foreground rounded-md p-2 cursor-move ${
