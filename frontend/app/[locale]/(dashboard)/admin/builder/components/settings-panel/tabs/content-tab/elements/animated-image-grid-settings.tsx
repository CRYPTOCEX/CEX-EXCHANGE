                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2 max-h-80 overflow-y-auto border rounded-md p-2">
                              ...
                              {editingImageIndex === index ? (
                                <div className="space-y-3">
                                  <div className="space-y-1">
                                    ...
                                    {/* The `h-24` wrapper is gone: ImageUpload
                                        owns its own height, and the wrapper
                                        was 96px around a control that rendered
                                        128–160px tall and spilled over the
                                        block below it. */}
                                    <ImageUpload
                                      value={image.light}
                                      onChange={(fileOrNull) =>
                        ...
                        {(!imageColumns[colKey] ||
                          ...
                          <div className="text-center py-4 text-subtle-foreground text-sm">
