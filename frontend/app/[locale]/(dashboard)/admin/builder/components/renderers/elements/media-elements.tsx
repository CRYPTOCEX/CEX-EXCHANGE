      ...
      >
        {settings.src ? (
          <img
            ...
            alt={settings.alt || tCommon("image")}
            className={cn(
        ...
        {images[activeIndex]?.src ? (
          ...
          >
            <img
              ...
              alt={images[activeIndex].alt || t("gallery_image")}
              className={cn(
...
function NavButton({
  ...
  return (
    <button
      ...
      className="absolute z-10 flex items-center justify-center w-8 h-8 text-overlay-foreground bg-overlay/50 rounded-full hover:bg-overlay/70 transition-colors"
      style={{
