  ...
  return (
    ...
    >
      ...
      {showGradients && (
        <>
          <div
            className="absolute top-0 bottom-0 left-0 w-40 z-50 flex items-center justify-center bg-linear-to-r from-card to-transparent from-background pointer-events-auto"
          ...
          <div
            className="absolute top-0 bottom-0 right-0 w-40 z-50 flex items-center justify-center bg-linear-to-l from-card to-transparent from-background pointer-events-auto"
