    ...
    >
      <div
        style={{
          ...
          maxWidth: "200px",
          textAlign: "center",
          // Was a hardcoded `#333`, which is dark grey on a dark canvas: the
          // drag label was unreadable in dark mode. The preview sits on a 10%
          // tint of the page itself, so it must take the page ink.
          color: "hsl(var(--foreground))",
          fontWeight: 500,
          boxShadow: "0 2px 10px hsl(var(--overlay) / 0.25)",
        }}
      >
        {getItemLabel()}
      </div>
