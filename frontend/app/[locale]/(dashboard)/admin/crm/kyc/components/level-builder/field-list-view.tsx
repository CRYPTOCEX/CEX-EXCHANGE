            ...
            >
              <Card
                className={`border transition-all ${
                  ...
                  draggedIndex === index
                    ? "border-dashed border-primary/70 bg-primary/5 dark:bg-primary/10"
                    : selectedField?.id === field.id
                      ? "border-primary bg-muted"
                      : "hover:border-muted-foreground/50 border-border-strong"
                }`}
                onClick={() => {
              ...
              >
                <CardContent className="p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`flex items-center justify-center h-8 w-8 rounded-md ${FIELD_TONE.chip}`}
                    >
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="cursor-move p-1 rounded-md hover:bg-muted">
