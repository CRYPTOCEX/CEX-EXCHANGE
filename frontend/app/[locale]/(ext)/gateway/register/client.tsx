...
export default function MerchantRegisterClient() {
  ...
  // Merchant onboarding is the door to processing third-party funds, so the
  // gate sits on the registration form itself. The page has no sign-in prompt of
  // its own, so "anonymous" renders nothing rather than a KYC notice.
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 pt-header">
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  maxLength={16}
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, phone: normalizePhoneE164(e.target.value) }))
                  }
                  placeholder={phoneCode ? `${phoneCode}712345678` : "+254711972926"}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="businessType">{tCommon("business_type")}</Label>
                <Input
                  id="businessType"
                  name="businessType"
