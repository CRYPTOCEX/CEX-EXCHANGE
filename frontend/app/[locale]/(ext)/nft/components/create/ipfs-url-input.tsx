  ...
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                loading={imageValidating}
                disabled={!imageUrl.trim()}
                size="default"
              >
                {!imageValidating && t("validate")}
              </Button>
            </div>
          </div>
      ...
      <Card className="border-2 border-dashed">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label>{t("ipfs_metadata_json_url")}</Label>
            <div className="flex gap-2">
              <Input
                value={metadataUrl}
                onChange={(e) => {
              ...
              <Button
                ...
                loading={metadataValidating}
                disabled={!metadataUrl.trim()}
                variant="outline"
              >
                {!metadataValidating && t("validate")}
              </Button>
            </div>
          </div>
