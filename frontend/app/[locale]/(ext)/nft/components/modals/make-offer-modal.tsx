          ...
          {getFloorPrice() > 0 && (
            <div className="bg-muted/50 rounded-lg p-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium flex items-center gap-1.5">
                  <CurrencyIcon currency="ETH" size={16} />
                  {getFloorPrice()} ETH
                </span>
              </div>
            </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                          ...
                          {CURRENCIES.map((currency) => (
                            <SelectItem key={currency.value} value={currency.value}>
                              <span className="flex items-center gap-2">
                                <CurrencyIcon currency={currency.value} size={16} />
                                {currency.label}
                              </span>
                            </SelectItem>
                          ))}
              ...
              <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{tCommon("expires")}</span>
                    <span>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button type="submit" disabled={loading || watchedAmount <= 0} className="flex-1">
                  {loading ? t("making_offer") : tCommon("make_offer")}
                </Button>
              </div>
            </form>
          </Form>
