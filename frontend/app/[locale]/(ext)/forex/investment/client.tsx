...
import {
  useForexInvestmentColumns,
  useForexInvestmentViewConfig,
} from "../dashboard/components/columns";
...
export default function ForexInvestmentsClient() {
  ...
  const forexInvestmentViewConfig = useForexInvestmentViewConfig();
  ...
  return (
    <DataTable
      ...
      viewConfig={forexInvestmentViewConfig}
