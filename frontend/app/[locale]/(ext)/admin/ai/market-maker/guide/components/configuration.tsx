    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="pt-6">
          <h2 className="text-xl font-semibold leading-tight tracking-tight text-foreground mb-4">
          ...
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionContent>
                <div className="space-y-4 p-2">
                  <div className="border-l-2 border-primary pl-4">
                    <h5 className="font-medium text-foreground">{t("trading_enabled")}</h5>
                  ...
                  <div className="border-l-2 border-warning pl-4">
                    <h5 className="font-medium text-foreground">{t("global_pause")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
                  ...
                  <div className="border-l-2 border-destructive pl-4">
                    <h5 className="font-medium text-foreground">{tExt("maintenance_mode")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
            ...
            <AccordionItem value="bot-limits">
              ...
              <AccordionContent>
                <div className="space-y-4 p-2">
                  <div className="border-l-2 border-primary pl-4">
                    <h5 className="font-medium text-foreground">{t("max_concurrent_bots")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
                  ...
                  <div className="border-l-2 border-primary pl-4">
                    <h5 className="font-medium text-foreground">{t("bot_intervals")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
            ...
            <AccordionItem value="risk-management">
              ...
              <AccordionContent>
                <div className="space-y-4 p-2">
                  <div className="border-l-2 border-destructive pl-4">
                    <h5 className="font-medium text-foreground">{tExt("max_daily_loss")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
                      {t("percentage_of_tvl_if_daily_losses")}
                    </p>
                    <div className="mt-2 p-2 bg-destructive/10 dark:bg-destructive/20 rounded text-xs text-destructive-ink">
                      <strong>{tCommon("warning")}</strong> {t("setting_this_too_high_can_result")}
                    </div>
                  </div>

                  <div className="border-l-2 border-warning pl-4">
                    <h5 className="font-medium text-foreground">{t("volatility_threshold")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
                      {t("price_volatility_percentage_that_triggers_automatic")} {t("protects_during_flash_crashes")}
                    </p>
                    <div className="mt-2 p-2 bg-muted rounded text-xs">
                      <strong>{tCommon("recommended")}</strong> 5-15% depending on asset volatility
                    </div>
                  </div>

                  <div className="border-l-2 border-success pl-4">
                    <h5 className="font-medium text-foreground">{t("min_liquidity")}</h5>
                    <p className="text-sm text-muted-foreground mt-1">
                ...
                <div className="space-y-4 p-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-sm text-foreground">{t("price_range_min_max")}</h5>
                      <p className="text-xs text-muted-foreground mt-1">
                        {t("acceptable_range_for_price_movement_bots")}
                      </p>
                    </div>
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-sm text-foreground">{t("aggression_level")}</h5>
                      <p className="text-xs text-muted-foreground mt-1">
                        {t("how_aggressively_to_move_toward_target_options")} <strong>Conservative</strong> (,),{" "}
                        <strong>Moderate</strong> (, or), or <strong>Aggressive</strong> (.).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-3 bg-primary/10 dark:bg-primary/20 rounded-lg">
                    <div className="flex gap-2">
                      ...
                      <div>
                        <h5 className="font-medium text-sm text-primary">{t("when_to_update_target_price")}</h5>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b">
                          ...
                          <th className="text-left py-2 px-3">{tCommon("best_for")}</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="border-b">
                          ...
                          <td className="py-2 px-3 text-muted-foreground">{t("stable_assets_high_liquidity")}</td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2 px-3 font-medium">Normal</td>
                          <td className="py-2 px-3">0.3% - 0.8%</td>
                          <td className="py-2 px-3 text-muted-foreground">{t("most_markets_recommended")} ({tCommon("recommended")})</td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2 px-3 font-medium">Wide</td>
                          <td className="py-2 px-3">0.8% - 2%</td>
                          <td className="py-2 px-3 text-muted-foreground">{t("volatile_assets_low_liquidity")}</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-3 font-medium">{t("very_wide")}</td>
                          <td className="py-2 px-3">2% - 5%</td>
                          <td className="py-2 px-3 text-muted-foreground">{t("exotic_illiquid_assets")}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="space-y-4 p-2">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 border rounded-lg">
                      <h5 className="font-medium text-sm text-foreground">{t("max_daily_volume")}</h5>
                      <p className="text-xs text-muted-foreground mt-1">
                    ...
                    <div className="p-3 border rounded-lg">
                      <h5 className="font-medium text-sm text-foreground">{t("real_liquidity")} %</h5>
                      <p className="text-xs text-muted-foreground mt-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h5 className="font-medium text-foreground">{t("base_balance")}</h5>
                </div>
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h5 className="font-medium text-foreground">{t("quote_balance")}</h5>
                </div>
                <p className="text-xs text-muted-foreground">
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h5 className="font-medium text-foreground">{t("balance_ratio")}</h5>
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="p-4 bg-warning/10 dark:bg-warning/20 rounded-lg">
              <div className="flex gap-3">
                <TriangleAlert className="w-5 h-5 text-warning shrink-0" />
                <div>
                  <h5 className="font-medium text-sm text-warning">{t("pool_sizing_tips")}</h5>
