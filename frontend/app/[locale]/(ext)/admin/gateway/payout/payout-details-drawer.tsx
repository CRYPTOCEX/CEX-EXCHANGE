        ...
        {loading ? (
          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="flex items-start justify-between">
              ...
              <Badge tone={statusTone(payout.status)} appearance="solid">
                {payout.status}
              </Badge>
            </div>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <p className="text-lg font-bold">
                    <MoneyFigure value={formatCurrency(payout.grossAmount, payout.currency)} />
                  </p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground">Fee</p>
                  <p className="text-lg font-medium text-muted-foreground">
                    <MoneyFigure value={formatCurrency(payout.feeAmount, payout.currency)} />
                  </p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground">Net</p>
                  <p className="text-lg font-bold text-success">
                    <MoneyFigure value={formatCurrency(payout.netAmount, payout.currency)} />
                  </p>
                </div>
              </div>
            </div>
