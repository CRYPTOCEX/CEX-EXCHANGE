...
export function AnalyticsCards({
  ...
  const totalRewardsDistributed = analytics.rewardsCredited?.total;
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {analytics.currency ? `${analytics.totalStaked.toLocaleString()} ${analytics.currency}` : "Currency-normalized total unavailable"}
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {(analytics.totalStakers ?? analytics.totalUsers ?? 0).toLocaleString()}
          </div>
          <p className="text-xs text-muted-foreground mt-1">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {totalRewardsDistributed != null && analytics.currency ? `${totalRewardsDistributed.toLocaleString()} ${analytics.currency}` : "Currency-normalized total unavailable"}
          </div>
          <p className="text-xs text-muted-foreground mt-1">
