...
const activityTypes = [
  { value: "MINT", label: "Mint", color: "bg-success" },
  { value: "TRANSFER", label: "Transfer", color: "bg-primary" },
  { value: "SALE", label: "Sale", color: "bg-primary" },
  { value: "LIST", label: "List", color: "bg-warning" },
  { value: "DELIST", label: "Delist", color: "bg-muted" },
  { value: "BID", label: "Bid", color: "bg-warning" },
  { value: "OFFER", label: "Offer", color: "bg-primary" },
  { value: "BURN", label: "Burn", color: "bg-destructive" },
];
    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                ...
                <Input
                  id="search"
                  placeholder={`${t("transaction_hash_user_email")}…`}
                  value={searchQuery}
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="collection">
                <SelectValue placeholder={loadingCollections ? `${tCommon("loading")}…` : tExt("all_collections")} />
              </SelectTrigger>
              <SelectContent>
          ...
          {activeFilters.collectionId && (
            <div className="space-y-2">
              <Label htmlFor="token">{t("nft_token")}</Label>
              <Select
              ...
              >
                <SelectTrigger id="token">
                  <SelectValue placeholder={loadingTokens ? `${tCommon("loading")}…` : tExt("all_tokens")} />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="creator">
                <SelectValue placeholder={loadingCreators ? `${tCommon("loading")}…` : tExtAdmin("all_creators")} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">{t("all_creators")}</SelectItem>
                {creators.map((creator) => (
                  <SelectItem key={creator.id} value={creator.id}>
                    {creator.displayName || creator.user?.email || tCommon("unknown")}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
