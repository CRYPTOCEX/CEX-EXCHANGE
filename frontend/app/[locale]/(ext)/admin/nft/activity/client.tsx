...
export default function NFTActivityClient() {
  ...
  const fetchActivities = useCallback(async (pageNum: number, resetData: boolean = false) => {
    try {
      ...
      setError(err.message || t("failed_to_load_nft_activities"));
    } finally {
      setIsLoading(false);
    }
  }, [filters, activities]);
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      toast.error(err?.message || t("failed_to_delete_activity"));
    }
  };
  ...
  return (
    <div className=" relative min-h-screen">
      {/* Hero Background */}
      <div className="absolute inset-0 h-[200px] bg-linear-to-b from-muted/50 via-muted/20 to-transparent">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold tracking-tight">{t("nft_activity")}</h1>
