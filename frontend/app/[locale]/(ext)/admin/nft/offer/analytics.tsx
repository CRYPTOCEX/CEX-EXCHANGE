  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        metric: "totalAcceptedValue",
        model: "nftOffer",
        aggregation: { field: "amount", op: "sum", where: [{ field: "status", value: "ACCEPTED" }] },
        icon: "mdi:cash-check",
      },
      {
        id: "avg_accepted_value",
        title: "Avg Accepted Value",
        metric: "avgAcceptedValue",
        model: "nftOffer",
        aggregation: { field: "amount", op: "avg", where: [{ field: "status", value: "ACCEPTED" }] },
        icon: "mdi:cash",
      },
    ],
  },
    ...
    items: [
      {
        ...
        type: "line",
        model: "nftOffer",
        metrics: ["totalOfferAmount", "avgOfferAmount"],
        timeframes: ["24h", "7d", "30d", "3m", "6m", "y"],
        labels: {
          totalOfferAmount: "Total Offer Amount",
          avgOfferAmount: "Average Offer Amount",
        },
      },
    ],
  },
