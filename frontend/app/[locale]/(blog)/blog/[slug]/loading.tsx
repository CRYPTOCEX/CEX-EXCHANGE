    ...
    <div className="min-h-screen relative overflow-hidden bg-card pt-24 pb-16">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        <article className="mx-auto max-w-4xl">
            ...
            <div className="relative h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[65vh] w-full overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 lg:p-12">
                <div className="mx-auto max-w-3xl">
                  ...
                  <Skeleton className="h-6 sm:h-7 w-20 sm:w-24 rounded-full mb-3 sm:mb-4 bg-card/20" />

                  {/* Title skeleton */}
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    <Skeleton className="h-8 sm:h-10 md:h-12 lg:h-14 w-full bg-card/20" />
                    <Skeleton className="h-8 sm:h-10 md:h-12 lg:h-14 w-4/5 bg-card/20" />
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex items-center">
                      <Skeleton className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-card/20" />
                      <Skeleton className="ml-2 sm:ml-3 h-4 sm:h-5 w-24 sm:w-32 bg-card/20" />
                    </div>

                    {/* Meta info (date, reading time, comments) */}
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                      <Skeleton className="h-4 w-20 sm:w-24 bg-card/20" />
                      <Skeleton className="h-4 w-16 sm:w-20 bg-card/20" />
                      <Skeleton className="h-4 w-20 sm:w-24 bg-card/20" />
                    </div>
                  </div>
                </div>
          ...
          {/* Author bio skeleton */}
          <div className="mt-8 sm:mt-10 md:mt-12 border-t border-border pt-6 sm:pt-8">
            <div className="bg-linear-to-br from-primary to-card dark:from-primary/20 dark:to-surface-2/80 p-4 sm:p-6 md:p-8 rounded-xl">
          ...
          <div className="mt-8 sm:mt-10 md:mt-12 border-t border-border pt-6 sm:pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="overflow-hidden rounded-xl shadow-md bg-muted">
