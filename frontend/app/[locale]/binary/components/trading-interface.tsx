...
// Binary is a live-money surface and had no error boundary at all: any render throw
// in the chart, order panel or positions list white-screened the whole page.
import { TradingInterfaceErrorBoundary } from "./error-boundaries";
...
export default function TradingInterface({
  ...
  // Tutorial hook for interactive onboarding. It no longer opens itself: a tour
  // that fires on a first visit arrives before anyone is stuck and gets
  // dismissed reflexively, while the same tour asked for — from the Help
  // control here, or from the support assistant — is wanted when it lands.
