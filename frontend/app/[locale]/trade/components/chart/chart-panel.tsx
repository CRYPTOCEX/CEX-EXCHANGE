  ...
  if (!symbol) {
    return (
      <div className="w-full h-full bg-background flex items-center justify-center text-foreground">
        <div className="flex flex-col items-center gap-4 p-6 bg-card border border-border rounded-lg max-w-md text-center">
          <span className="grid h-12 w-12 shrink-0 place-items-center rounded-lg bg-destructive/15 text-destructive">
