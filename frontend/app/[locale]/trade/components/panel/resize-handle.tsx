  ...
  return (
    <div
      ...
      className={cn(
        ...
        resizing
          ? "bg-primary/80 opacity-100 scale-y-[1.5]"
          : "bg-border-strong/70 hover:bg-primary/50 opacity-70 hover:opacity-100",
        className,
        dynamicClassName
      )}
    ...
    >
      ...
      >
        <div className="w-0.5 h-0.5 rounded-full bg-muted-foreground/70" />
        <div className="w-0.5 h-0.5 rounded-full bg-muted-foreground/70" />
        <div className="w-0.5 h-0.5 rounded-full bg-muted-foreground/70" />
      </div>
      ...
      {showTooltip && (
        <div
          className="absolute z-50 bg-popover text-popover-foreground border border-border text-xs rounded px-2 py-1 whitespace-nowrap pointer-events-none animate-in fade-in duration-200"
          style={{
