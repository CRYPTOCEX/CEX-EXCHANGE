            ...
            {isSaveDialogOpen ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm bg-[var(--tp-blue)] text-[var(--tp-blue-fg)] rounded hover:bg-[var(--tp-blue-dim)] disabled:opacity-50"
                >
                  Save
                </button>
              </div>
              ...
              >
                <Plus size={14} />
                <span>{tTrade("save_current_layout")}</span>
              </button>
            )}
          </div>
        </div>
