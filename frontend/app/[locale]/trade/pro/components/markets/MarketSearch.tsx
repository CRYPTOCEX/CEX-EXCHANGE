    ...
    >
      ...
      {value ? (
        ...
        <div className="pr-2 flex-shrink-0">
          {/* Keycap: label ink on the elevated ground measured 2.95:1 at 9px.
              A keycap has to be readable, so it takes primary ink. */}
          <kbd className="px-1 py-px text-[9px] text-[var(--tp-text-primary)] bg-[var(--tp-bg-elevated)] rounded font-mono">
            /
          </kbd>
        </div>
      )}
