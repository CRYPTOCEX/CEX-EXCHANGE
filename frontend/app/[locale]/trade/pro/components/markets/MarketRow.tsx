  ...
  return (
    <div
      ...
      className={cn(
        ...
        "transition-colors",
        // ECO is a market TYPE, not a price direction — green here read as "up"
        // in a row whose whole job is showing up/down. `--tp-purple` (=`--chart-4`)
        // is the slot the ECO badge in MobileMarketSelector already uses, so the
        // rail and the badge now say the same thing.
        market.isEco ? "border-l-2 border-l-[var(--tp-purple)]/60" : "border-l-2 border-l-transparent",
        isSelected
          ? "bg-[var(--tp-blue)]/10"
