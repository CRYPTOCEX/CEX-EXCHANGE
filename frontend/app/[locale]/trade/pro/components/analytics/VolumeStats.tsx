...
import { themeColor } from "../../utils/canvas-color";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {hoveredHour !== null && (
          <div
            className="absolute top-0 bg-[var(--tp-bg-secondary)] border border-[var(--tp-border)] rounded px-2 py-1 shadow-lg pointer-events-none z-10"
            style={{
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between p-2 bg-[var(--tp-bg-secondary)] rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[var(--tp-text-secondary)]">{tCommon("best_hour")}</span>
          </div>
        ...
        <div className="flex items-center justify-between p-2 bg-[var(--tp-bg-secondary)] rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[var(--tp-text-secondary)]">{tCommon("worst_hour")}</span>
          </div>
          <div className="text-right">
            <span className="text-xs font-medium text-[var(--tp-text-primary)]">
        ...
        <div className="flex items-center justify-between p-2 bg-[var(--tp-bg-secondary)] rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[var(--tp-text-secondary)]">{t("most_active")}</span>
          </div>
          <div className="text-right">
            <span className="text-xs font-medium text-[var(--tp-text-primary)]">
