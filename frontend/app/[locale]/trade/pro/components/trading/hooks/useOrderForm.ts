...
const DEFAULT_ADVANCED_OPTIONS: AdvancedOptionsState = {
  // GTC is what every order on the platform already is, and what the backend
  // assumes when the field is absent. Any other default would silently change
  // the behaviour of every order placed from this form.
  timeInForce: "GTC",
  reduceOnly: false,
};
