...
interface SwipeablePanelProps {
  ...
  className?: string;
  /**
   * Suppress gesture handling. Set while the chart tab is showing: the chart owns
   * its own pan/zoom touch handling, and a horizontal swipe here would fight it
   * (this panel calls preventDefault once it decides a drag is horizontal).
   */
  disabled?: boolean;
}
...
export const SwipeablePanel = memo(function SwipeablePanel({
  ...
  const handleTouchMove = useCallback(
    ...
    [disabled, touchStart, isHorizontalSwipe]
  );
