        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <div className="flex-1">
              <label className="text-[10px] text-[var(--tp-text-muted)]">{tCommon("take_profit")}</label>
              <input
                type="text"
                value={tp}
            ...
            <div className="flex-1">
              <label className="text-[10px] text-[var(--tp-text-muted)]">{tCommon("stop_loss")}</label>
              <input
                type="text"
                value={sl}
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-1.5 text-xs font-medium bg-[var(--tp-blue)] text-[var(--tp-blue-fg)] rounded hover:bg-[var(--tp-blue)]/80 transition-colors"
            >
              Save
            </button>
            <button
