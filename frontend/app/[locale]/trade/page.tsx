  ...
  return (
    <div className="h-screen w-full bg-background flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">{t("loading_trading_pro")}…</p>
      </div>
    </div>
  );
}
...
function TradePageContent() {
  ...
  const gate = useKycGate(requiredFeature);
  ...
  // "anonymous" and "loading" fall through so visitors keep seeing the page.
  ...
  // Boundary parity with TradingPro: without it, any render crash in a child
  // panel unmounts the entire page into the app error screen (observed as
  // "market page opens then goes dead"), with nothing logged client-side.
  return (
