          ...
          <TooltipTrigger asChild>
            <m.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                size="sm"
                className={cn(
                  "h-10 rounded-none border-0 relative",
                  "transition-all duration-300",
                  // /15 is documented as a HOVER-only step; this is a resting
                  // selected state, so it takes the /10 ceiling. The selection
                  // is still unambiguous — the `viewModeIndicator` underline
                  // below carries it on its own.
                  viewMode === "table"
