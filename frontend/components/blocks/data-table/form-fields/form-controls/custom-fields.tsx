...
export interface CustomField {
  ...
  type: "input" | "textarea" | "file" | "image" | "qr" | "text";
  required: boolean;
}
...
export function CustomFieldsFormControl({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="overflow-x-auto border border-border-strong rounded-md">
                ...
                <tr key={index} className="border-b last:border-none">
                  ...
                  <td className="px-4 py-2">
                    ...
                    >
                      ...
                      <SelectContent className="z-[var(--z-popover-elevated)]">
