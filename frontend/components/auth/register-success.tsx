  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-6 text-center space-y-6">
      ...
      <div className="relative">
        <div className="w-20 h-20 bg-success/30 rounded-full flex items-center justify-center animate-pulse">
      ...
      {needsEmailVerification ? (
        <div className="bg-primary/10 dark:bg-primary/20 border border-primary/30 rounded-lg p-4 max-w-md">
        ...
        <div className="bg-success/20 border border-success rounded-lg p-4 max-w-md">
