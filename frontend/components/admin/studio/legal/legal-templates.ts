...
<section class="mb-12">
  ...
  if (options.includeMission) {
    sections.push(`
<section class="mb-12 p-8 bg-primary/5 rounded-lg">
  ...
  if (options.includeVision) {
    sections.push(`
<section class="mb-12 p-8 bg-secondary/50 rounded-lg">
...
<section class="mb-12">
  ...
  <div class="relative ps-8 border-s-2 border-primary/30">
    <div class="mb-8">
      <div class="absolute -start-2 w-4 h-4 rounded-full bg-primary"></div>
    ...
    ${yearsInBusiness > 0 ? `
    <div class="mb-8">
      <div class="absolute -start-2 w-4 h-4 rounded-full bg-primary/60"></div>
    ...
    ` : ""}
    <div>
      <div class="absolute -start-2 w-4 h-4 rounded-full bg-primary/30"></div>
  ...
  if (options.includeStats) {
    sections.push(`
<section class="mb-12 p-8 bg-linear-to-r from-primary/10 to-secondary/10 rounded-lg">
...
<section class="mb-12">
  ...
  // Contact CTA
  sections.push(`
<section class="text-center p-8 bg-primary/5 rounded-lg">
...
<div class="p-4 bg-primary/10 rounded-lg border border-primary/30 mb-8">
  <p class="text-sm">
  ...
  // Table of Contents
  sections.push(`
<section class="mb-8 p-6 bg-muted/50 rounded-lg">
...
<section id="information-sharing" class="mb-8">
  ...
  <div class="p-4 bg-success/30 rounded-lg border border-success">
...
<div class="p-4 bg-warning/10 rounded-lg border border-warning/30 mb-8">
  <p class="text-sm">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
  <div class="p-6 bg-card rounded-lg border border-border text-center">
  ...
  if (options.includeHours) {
    sections.push(`
<div class="mb-12 p-6 bg-primary/5 rounded-lg">
...
<section class="mb-12">
  ...
  <div class="max-w-2xl mx-auto p-8 bg-card rounded-lg border border-border">
...
<section class="text-center mb-12">
  ...
  <div class="flex justify-center gap-4">
    <a href="#" class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary-ink hover:bg-primary/20 transition-colors">
