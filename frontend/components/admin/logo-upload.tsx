  ...
  const handleUpload = async () => {
    if (!selectedFile) {
      toast({
        ...
        description: t("please_select_a_logo_file_to_upload"),
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          ...
          description: result.error || t("failed_to_upload_logo"),
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      setUploadResult({
        success: false,
        error: t("an_unexpected_error_occurred_during_upload"),
      });
      toast({
        title: tCommon("upload_failed"),
        description: t("an_unexpected_error_occurred_during_upload"),
        variant: "destructive",
      });
    } finally {
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Upload Result */}
          {uploadResult && (
            <Alert className={uploadResult.success ? "border-success bg-success/10" : "border-destructive bg-destructive/10"}>
              <div className="flex items-center gap-2">
                ...
                <AlertDescription className={uploadResult.success ? "text-success" : "text-destructive"}>
