...
export const WysiwygEditor = forwardRef<WysiwygEditorRef, WysiwygEditorProps>(function WysiwygEditor({
  ...
  const emailPreviewContent = useMemo(() => {
    ...
    const defaultSampleData: Record<string, string> = {
      ...
      DESCRIPTION: t("wallet_deposit_via_bank_transfer"),
      FEE: "2.50",
      NOTE: tCommon("transaction_processed_successfully"),
      REASON: "Verification required",

      // KYC related
      LEVEL: "Level 2",
      STATUS: "APPROVED",
      MESSAGE: t("your_documents_have_been_verified_successfully"),
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-auto relative bg-background transition-colors">
        {viewMode === "edit" && (
          <>
            {/* Editable Area */}
            <div
