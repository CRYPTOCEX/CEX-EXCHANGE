        ...
        <PopoverContent className="w-48 p-1" align="start">
          <div className="flex flex-col">
            ...
            >
              ...
              <span className="text-xl font-bold">{t("heading")} 1</span>
            </Button>
            <Button
              type="button"
              variant="ghost"
            ...
            >
              ...
              <span className="text-lg font-semibold">{t("heading")} 2</span>
            </Button>
            <Button
              type="button"
              variant="ghost"
            ...
            >
              ...
              <span className="text-base font-semibold">{t("heading")} 3</span>
            </Button>
            <Button
              type="button"
              variant="ghost"
            ...
            >
              ...
              <span className="text-sm font-semibold">{t("heading")} 4</span>
            </Button>
          </div>
        </PopoverContent>
      </Popover>
