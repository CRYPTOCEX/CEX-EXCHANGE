  ...
  const handleFileSelect = useCallback(
    async (files: FileList | File[]) => {
      ...
      if (imageFiles.length === 0) {
        setError(t("please_select_image_files"));
        return;
      }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-4 border-b shrink-0">
        ...
        <div>
          <h2 className="text-lg font-semibold">{t("add_media")}</h2>
          <p className="text-xs text-muted-foreground">
            {t("upload_files_or_insert_from_url")}
          </p>
        </div>
      </div>
              ...
              >
                ...
                {uploading ? (
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      <p className="text-lg font-medium">{tCommon("uploading")}…</p>
                      <p className="text-sm text-muted-foreground">
                        {t("please_wait_while_your_files_are_being_uploaded")}
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {t("png_jpg_gif_webp_up_to_10mb_each")}
                      </p>
                    </div>
                  </div>
                )}
              ...
              {uploadedFiles.length > 0 && (
                <div className="space-y-2">
                  <p className="text-sm font-medium">
                    {uploading ? tCommon("uploading") : t("uploaded")} files:
                  </p>
                  <div className="space-y-2">
                  ...
                  >
                    <div className="relative rounded-lg border overflow-hidden bg-muted">
                      <img
                        ...
                        onError={() => {
                          setError(t("failed_to_load_image_from_url"));
                          setPreviewUrl(null);
                        }}
                      />
                      <Button
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder={t("describe_the_image_for_accessibility")}
                      />
                    </div>
