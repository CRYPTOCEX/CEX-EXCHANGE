    ...
    <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 xl:grid-cols-8 gap-3 p-4">
      {files.map((file) => (
        ...
        >
          ...
          <div
            className={cn(
              "absolute inset-0 bg-overlay/50 opacity-0 group-hover:opacity-100 transition-opacity",
          ...
          >
              ...
              <div
                className={cn(
                  ...
                  selectedFiles.has(file.id)
                    ...
                    : "bg-overlay-foreground/80 border-overlay-foreground/50 hover:border-overlay-foreground"
                )}
              >
                {selectedFiles.has(file.id) && (
            ...
            {/* File name */}
            <div className="absolute inset-x-0 bottom-0 p-2 bg-linear-to-t from-overlay/80 to-transparent">
              <p className="text-xs text-overlay-foreground truncate font-medium">
                {file.name}
              </p>
              <p className="text-[10px] text-overlay-foreground/70">
