      ...
      <div className="flex flex-col w-full">
        ...
        <textarea
          ...
          className={cn(
            ...
            paddingClass,
            hasError &&
              "border-2 border-destructive focus:ring-destructive focus:ring-2",
            className
          )}
          onBlur={handleBlur}
        ...
        {hasError && errorMsg && (
          <div className="flex items-center gap-2 text-destructive-ink text-sm mt-1 bg-destructive/10 p-2 rounded-md">
