...
import { m, useMotionValue, useTransform, useInView } from "framer-motion";
    ...
    <div className="hidden lg:block flex-1 mx-4 relative h-px">
      ...
      <m.div
        ...
        style={{
          ...
          boxShadow: `0 0 20px ${withAlpha(gradient.from, 0.5)}`,
        }}
...
function StepCard({
  ...
  const cardStyles: Record<string, string> = {
    ...
    gradient: "bg-card dark:bg-surface-2/80",
    premium:
  ...
  return (
    ...
    >
      ...
      <m.div
        ...
        style={{
          background: `linear-gradient(135deg, ${withAlpha(gradient.from, 0.25)}, ${withAlpha(gradient.to, 0.25)})`,
        }}
      />
      ...
      <div
        ...
        style={{
          boxShadow: `0 15px 40px -10px hsl(var(--shadow) / 0.1)`,
        }}
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 30% 0%, ${withAlpha(gradient.from, 0.19)} 0%, transparent 60%)`,
          }}
        />
        ...
        <div className="relative z-10 flex flex-col h-full">
            ...
            <div
              ...
              style={
                iconStyle === "filled"
                  ? {
                      background: `linear-gradient(135deg, ${gradient.from}, ${gradient.to})`,
                      boxShadow: `0 8px 24px ${withAlpha(gradient.from, 0.19)}`,
                    }
                  : iconStyle === "outlined"
                    ? {
          ...
          <m.div
            ...
            style={{
              background: `linear-gradient(90deg, transparent, ${withAlpha(gradient.from, 0.19)}, transparent)`,
            }}
            initial={{ scaleX: 0 }}
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at 100% 0%, ${withAlpha(gradient.to, 0.25)}, transparent 70%)`,
          }}
        />
      </div>
    </m.div>
...
export default function ProcessSection({
  ...
  /**
   * Step markers, all in the accent.
   *
   * This was the six-slot chart ramp indexed by step number. The ramp is for
   * CATEGORICAL data — entities a reader cross-references — and "step 3 of 4"
   * is a sequence, not a category; its order is already carried by the number
   * printed inside the marker and by the position on the timeline. Because this
   * component ships on nearly every landing page, that one array was painting
   * four extra hues onto /staking, /affiliate, /ico, /p2p, /gateway,
   * /copy-trading and /trading-bot alike — invisible to `design:check`, which
   * cannot see a token inside a JS string.
   */
  const gradientColors = [
    { from: primaryColor, to: withAlpha(primaryColor, 0.75) },
  ];
          ...
          <div key={step.id || index} className="relative">
            <div className="flex gap-6">
              <div className="flex flex-col items-center">
                <m.div
                  /* Ink must follow the marker fill, which is now a filled
                     `--primary` rather than `--chart-1`. Left as `text-overlay-foreground`
                     it drops from 3.66:1 to 2.95:1 in dark mode on 18px bold
                     text — and to 2.33:1 when a caller themes the section with
                     a status name. `primary-foreground` is the designed pair. */
                  className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg tabular-nums text-primary-foreground"
                  style={{
            ...
            <div className="flex-1 flex justify-center">
              {step.image ? (
                ...
                <m.div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${withAlpha(stepGradient.from, 0.06)}, ${withAlpha(stepGradient.to, 0.06)})`,
                  }}
        ...
        {showConnectors && steps.length > 1 && (
          <div className="hidden md:block relative">
            <m.div
              ...
              style={{
                background: `linear-gradient(90deg, transparent, ${withAlpha(gradient.from, 0.31)}, ${withAlpha(gradient.to, 0.31)}, transparent)`,
              }}
              initial={{ scaleX: 0 }}
              whileInView={{ scaleX: 1 }}
              viewport={{ once: true }}
              ...
              return (
                <m.div
                  ...
                  style={{
                    ...
                    background: `linear-gradient(135deg, ${stepGradient.from}, ${stepGradient.to})`,
                    boxShadow: `0 0 20px ${withAlpha(stepGradient.from, 0.38)}`,
                  }}
                  initial={{ scale: 0, opacity: 0 }}
            ...
            >
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${withAlpha(stepGradient.from, 0.08)}, ${withAlpha(stepGradient.to, 0.08)})`,
                    border: `1px solid ${withAlpha(stepGradient.from, 0.15)}`,
                  }}
                >
                  {Icon ? (
                    <Icon
