              ...
              <div className="flex-1 w-full">
                {feature.image ? (
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${withAlpha(primaryColor, 0.06)}, ${withAlpha(primaryColor, 0.02)})`,
                    }}
                  >
                    {feature.icon && (
                      <feature.icon
                        className="w-24 h-24"
                        style={{ color: `${withAlpha(primaryColor, 0.25)}` }}
                      />
                    )}
                  </div>
                )}
      ...
      <div className={`grid ${columnsClasses[columns]} ${gapClasses[gap]}`}>
        {features.map((feature, index) => (
          <m.div
            ...
            className="group text-center p-6 rounded-lg bg-card transition-all duration-300"
          >
            {feature.icon && (
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${withAlpha(primaryColor, 0.08)}, ${withAlpha(primaryColor, 0.02)})`,
                  boxShadow: `0 0 0 0 ${withAlpha(primaryColor, 0.25)}`,
                }}
              >
